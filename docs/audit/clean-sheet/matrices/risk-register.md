...
| RR-109 | Driver instant cash-out exists in the backend but has no driver-app screen. **Superseded 2026-09-25: owner decision weekly-only, no instant payouts.** | BENCH-004 | MEDIUM-HIGH | 3×4×3 = 36 † | VERIFIED | MOBILE + BE-PAY | Open | X3 |
