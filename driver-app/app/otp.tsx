...
export default function OtpScreen() {
  ...
  const handleVerify = async () => {
    ...
    console.log('Verifying OTP:', code, 'for', phoneNumber, 'in mode:', mode);
    console.log('Backend URL:', SpinrConfig.backendUrl);
    ...
    try {
      if (isBackendMode) {
        ...
        console.log('Backend Verify Response:', response.status, response.data);
