...
2. **544 is a lot of refs to force-push at once.** Many are very likely stale/merged/abandoned
   (this repo has many short-lived AI-session branches — see `docs/audit/2026-09-13-pii-branch-exposure-full-scan.md`'s
   full list). Consider identifying and deleting confirmed-merged/stale branches first to
