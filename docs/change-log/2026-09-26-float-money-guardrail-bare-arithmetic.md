...
|---|---|---|
| `.semgrep/spinr-rules.yml` | Added SR-11 (`spinr-bare-dict-arithmetic-in-money-file`), merge-blocking | Catch the bare dict/subscript-arithmetic bug shape SR-03 misses |
...
```yaml
# After: SR-03 unchanged, plus new SR-11
