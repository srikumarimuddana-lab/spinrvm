...
This exception was previously undocumented here — flagged as ranked blocker #24 / finding N9 in `docs/audit/2026-08-18-full-fleet-whole-app-audit.md`. Whether to formally accept 3.5 s as a permanent SLA exception, or instead add a hard latency-preserving ceiling and accept the resulting undercharge-risk tail, is an **open decision** — owner Product/Eng lead, per the audit's decision log (due 2026-08-25 as of the audit). This note only makes the existing behavior visible; it does not resolve that decision.
