    ...
    try {
      ...
      await AsyncStorage.setItem(
        ...
        JSON.stringify({
          ...
          pickup_lat: parseFloat(data.pickup_lat || '0') || 0,
          pickup_lng: parseFloat(data.pickup_lng || '0') || 0,
          dropoff_lat: parseFloat(data.dropoff_lat || '0') || 0,
          dropoff_lng: parseFloat(data.dropoff_lng || '0') || 0,
          fare: data.fare ?? '0',
          distance_km: data.distance_km ? parseFloat(data.distance_km) || 0 : undefined,
          duration_minutes: data.duration_minutes ? parseFloat(data.duration_minutes) || 0 : undefined,
          rider_name: data.rider_name || undefined,
          rider_rating: data.rider_rating ? parseFloat(data.rider_rating) || undefined : undefined,
        }),
      );
    } catch (e) {
