...
**Date:** 2026-09-14
**Status:** Decided and implemented. What shipped: `docs/change-log/2026-09-14-spinr-app-phantom-domain-removal.md`. What is still open: `ACTION_ITEMS.md` C119 (a)–(h).
