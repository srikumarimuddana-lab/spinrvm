...
class ErrorCode(Enum):
    ...
    DRIVER_LICENSE_CLASS_INELIGIBLE = 5007
    DRIVER_VEHICLE_TOO_OLD = 5008
    DRIVER_INSUFFICIENT_EXPERIENCE = 5009
    DRIVER_UNDERAGE = 5010
    DRIVER_CRC_CONSENT_REQUIRED = 5011
