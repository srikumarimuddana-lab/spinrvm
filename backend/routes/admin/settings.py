...
class SettingsUpdateRequest(BaseModel):
    ...
    # Migration 490. Driver-app toasts through the unified toast; served to the
    # driver app as driver_unified_toast_enabled on /drivers/config.
    driver_unified_toast_enabled: Optional[bool] = None
