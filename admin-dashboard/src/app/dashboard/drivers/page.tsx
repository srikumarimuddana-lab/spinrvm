...
import DriverDocumentsTab from "./_components/driver-documents-tab";
import DriverSubscriptionsTab from "./_components/driver-subscriptions-tab";
    ...
    return (
        <div className="space-y-5">
            ...
            <DriverDetailSheet
                ...
                photoReviewing={photoReviewing}
                handlePhotoReview={handlePhotoReview}
                themeV2Enabled={themeV2Enabled}
                showPii={showPii}
                payoutSummary={payoutSummary}
                setPayoutSummary={setPayoutSummary}
                payoutLoading={payoutLoading}
                detailTab={detailTab}
                setDetailTab={setDetailTab}
                loadDriverRides={loadDriverRides}
                loadDriverReferrals={loadDriverReferrals}
                loadDriverSubscriptions={loadDriverSubscriptions}
                loadDriverTraining={loadDriverTraining}
                ...
                driverRidesTotalCount={driverRidesTotalCount}
                ...
                setRetryingPayoutId={setRetryingPayoutId}
                refreshingKyc={refreshingKyc}
                setRefreshingKyc={setRefreshingKyc}
                refreshingPayouts={refreshingPayouts}
                setRefreshingPayouts={setRefreshingPayouts}
                revealedSin={revealedSin}
                setRevealedSin={setRevealedSin}
