...
| `insurance-coverage-periods.md` | ☐ Counsel review · ☑ Consistency check against ToS §6/§13 (resolved 2026-08-18 — see the document's own pre-publication notes; content-complete pending only counsel review) | Draft |
