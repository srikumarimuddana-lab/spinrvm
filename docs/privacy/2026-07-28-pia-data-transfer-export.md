...
Recommendations: 2 Critical/High, 3 Medium, 2 Low (Section 8, 7 total: R-A through R-G). **Update 2026-07-28:** R-D (Medium) is DONE — see Section 8 for what was actually fixed (the investigation surfaced a more precise root cause than the original recommendation text assumed). 6 of 7 recommendations remain open (R-A, R-B, R-C, R-E, R-F, R-G).
