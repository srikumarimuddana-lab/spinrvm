...
- [x] `backend/tests/test_settings_column_parity.py` re-run — 31/31 passing, confirming the new field/column pair is in step (this is the exact static CI gate that would have caught the alternative of forgetting the migration).
