...
export default function LoginScreen() {
  ...
  const handleSendCode = async () => {
    ...
    try {
      console.log('Sending OTP to:', formattedNumber, 'using backend:', SpinrConfig.backendUrl);
      ...
      Alert.alert('Login Failed', `Error: ${error.message}. URL: ${SpinrConfig.backendUrl || 'Unknown'}`);
    } finally {
      setLoading(false);
    }
  };
