...
KNOWN_SETTINGS_COLUMNS = frozenset(
    {
        ...
        "dispatch_decline_reoffer_after_seconds",
        "dispatch_expanded_radius_after_seconds",
        "dispatch_expanded_radius_enabled",
        "dispatch_expanded_radius_max_km",
        "dispatch_expanded_radius_multiplier",
        "dispatch_max_offers_per_driver_per_ride",
        "dispatch_reoffer_enabled",
        ...
        "offer_expired_decline_as_miss_enabled",
