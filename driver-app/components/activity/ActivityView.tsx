...
export default function ActivityView() {
  ...
  // Filter rides by period and status
    ...
    >
      ...
      <View style={styles.ridesSection}>
        <View style={styles.ridesSectionHeader}>
          ...
          <Text style={styles.rideCount}>{loading ? '--' : filteredRides.length} rides</Text>
        </View>

        {/* Status Filter Pills */}
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.statusFilterWrapper} contentContainerStyle={styles.filterListContent}>
