# Spinr Non-Discrimination Policy — Draft for Legal Review

> **What this is.** A standalone policy giving legal weight to what's already
> a hard product rule (service-animal accommodation, WAV matching — see
> CLAUDE.md's Saskatchewan Regulatory section and ToS §14/Part B §14) by
> citing the actual statute and stating it as an enforceable policy, not just
> a feature description. Same plain-text/legal-viewer note as
> `community-guidelines.md`.
>
> **This is a draft, not legal advice**, has not been reviewed by counsel
> licensed in Saskatchewan or Canada, and the protected-grounds list below
> should be checked against the current text of the Saskatchewan Human
> Rights Code before publication — statutory lists are occasionally amended.
...
1. The protected-grounds list should be verified against the current
   Saskatchewan Human Rights Code text (and, if Spinr operates outside
   Saskatchewan in the future, the corresponding provincial/federal
   legislation) by counsel before publication.
2. Confirm the WAV availability language matches actual dispatch behavior —
