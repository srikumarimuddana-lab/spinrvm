...
- [ ] **N15. Remaining silent rider surfaces** — grouped rather than split,
  ...
  confirmation (R35/R37); ~~rider SOS sends the rider no confirmation that
  help was alerted (R38)~~; corporate allowance reset and exhaustion are
  silent, with exhaustion surfacing only as a 4xx at booking (R43/R44); and
  there is no "new device signed in" alert (R8).
  - **R38: done, 2026-08-11.** `trigger_emergency`
    ...
    26 pre-existing SOS tests re-run green. N15's checkbox stays `[ ]` — R19,
    R31/R33/R34, R35/R37, R43/R44, and R8 are still open.
