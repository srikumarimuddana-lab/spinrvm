...
Recommendations: 2 Critical/High, 3 Medium, 2 Low (Section 8, 7 total: R-A through R-G). **Update 2026-07-28:** R-A (High), R-C (Medium), and R-D (Medium) are DONE — see Section 8 for what was actually fixed in each (investigating R-A and R-D before implementing surfaced more precise root causes than the original recommendation text assumed; R-001's risk rating was corrected downward as part of R-A's remediation). 4 of 7 recommendations remain open (R-B, R-E, R-F, R-G).
