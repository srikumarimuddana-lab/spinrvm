            ...
            <Table>
              ...
              <TableBody>
                {sortedQuests.map((quest) => (
                  <>
                    <TableRow key={quest.id} className="cursor-pointer hover:bg-muted/50" onClick={() => handleExpandQuest(quest.id)} tabIndex={0} aria-label={`${quest.title}, press Enter to view participants`} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); handleExpandQuest(quest.id); } }}>
                      <TableCell>
