...
// R-P1-10: i18n — wire language selector to actually change the locale
        ...
        <View style={styles.card}>
          <TouchableOpacity style={styles.row} onPress={() => {
            setAlertState({
              ...
              message: t('settings.language_select_msg'),
              variant: 'info',
              buttons: [
                { text: 'English', onPress: () => { setLanguage('English'); i18n.changeLanguage('en-CA'); } },
                { text: 'Français', onPress: () => { setLanguage('Français'); i18n.changeLanguage('fr-CA'); } },
