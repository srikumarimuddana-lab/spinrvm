# Graph Report - spinrvm2  (2026-06-09)

## Corpus Check
- 1816 files · ~2,601,934 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 32888 nodes · 59045 edges · 3542 communities (1552 shown, 1990 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6638 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `66391ea1`
...
- `AgentTask` --uses--> `Run Comprehensive Code Review using Agent System Demonstrates how the orchestra`  [INFERRED]
  agents/base_agent.py → scripts/run_code_review.py
- `AgentTask` --uses--> `Run a comprehensive code review of the entire Spinr project.     The orchestrat`  [INFERRED]
  agents/base_agent.py → scripts/run_code_review.py
- `get_registry()` --calls--> `run_comprehensive_code_review()`  [INFERRED]
  agents/registry.py → scripts/run_code_review.py

## Communities (3542 total, 1990 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (271): admin_create_document_requirement(), admin_delete_document_requirement(), admin_get_document_requirements(), admin_get_driver_documents(), admin_get_pending_documents(), admin_review_driver_document(), admin_update_document_requirement(), admin_view_driver_document() (+263 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (120): _apply_filters(), _build_or_clause(), _build_or_clause_term(), _CircuitBreaker, claim_driver_atomic(), claim_stripe_event(), count_documents(), create_complaint() (+112 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (25): _driver(), Extended unit tests for routes/drivers.py.  Covers functions not exercised by, A single tower-handoff teleport must not inflate actual_distance_km.          Re, A single tower-handoff teleport must not inflate actual_distance_km., Heavy geometry → ride_routes (upsert); rides keeps only scalars., _ride(), TestArriveAtPickup, TestCancelRide (+17 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (270): SettingsPage(), usePlacesAutocomplete(), fetchLogs(), CompanyPortalLandingPage(), CreateRideModal(), distanceKm(), FareRow(), PriceBreakdown (+262 more)
...
Cohesion: 0.05
Nodes (142): Any, BackgroundTasks, bool, Decimal, float, Request, RideRatingRequest, bool (+134 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (85): Admin wallet operations — credit a user's wallet, view balance + history.  Eve, Compatibility shim for the removed ``db`` module.  Upstream commit ``33f252b4`, Identity passthrough kept for legacy callers.      The original implementation, serialize_doc(), int, str, Decimal, int (+77 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (29): AsyncMock, bool, float, str, PayoutRequest, Strict schema for driver profile updates — only whitelisted fields accepted., Strict schema for driver profile updates — only whitelisted fields accepted., UpdateDriverProfileRequest (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (143): delete_one(), find_nearby_drivers(), find_one(), get_rows(), insert_one(), update_one(), get_driver_documents(), Get all documents uploaded by the current driver. (+135 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (158): ForbiddenPage(), DAYS, emptyWindow(), DAYS, emptyWindow(), formatDate(), SettingsPage(), AllowanceDraft (+150 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (75): AllowanceRequestsPage(), Filter, STATUS_COLORS, save(), onRefresh(), baseAction(), computeOptimisticUpdates(), DESTRUCTIVE_ACTIONS (+67 more)
...
Cohesion: 0.06
Nodes (57): getBackendUrl(), API_URL, getBackendUrl(), { height }, LOCATION_CONFIGS, _notifee, RECONNECT_DELAYS, _surfaceOfferNotification() (+49 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (39): ConnectionManager, Broadcast to every socket connected to THIS machine.          Intentionally loca, Broadcast to every socket connected to THIS machine.          Intentionally lo, str, P1-6: WebSocket reconnect with state preservation (C8)  The server does not bu, A second connect() for the same client_id overwrites the old socket —         t, Server sends a WS event to a disconnected client — must not crash.          Th, When Redis pub/sub is unavailable, delivery falls back to local dict. (+31 more)
...
Cohesion: 0.06
Nodes (14): _build_or_clause_term(), _postgrest_pattern(), Escape PostgREST wildcard characters in user input., Convert one {col: predicate} pair into a PostgREST or_() leaf term., Unit tests for db_supabase.py helper functions.  db_supabase.py is at 46.3% —, TestAtomicClaims, TestBuildOrClause, TestBuildOrClauseTerm (+6 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (38): Any, bool, str, Unit tests for the admin WebSocket-health primitives.  Covers the two helpers, Regression for the Codex finding: a configured-but-unreachable Redis     must r, Regression for the Codex finding: after a failed reconnect drops the     subscr, test_active_requires_live_subscription(), test_connection_stats_buckets_by_client_type() (+30 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (123): async(), createStyles(), DriverArrivedScreenContent(), handleCancelPress(), handleCopyOtp(), createStyles(), DriverArrivingScreenContent(), handleBack() (+115 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (53): admin_get_surge_status(), Get current surge status for all active service areas., Get current surge status for all active service areas., calculate_distance(), get_service_area_polygon(), point_in_polygon(), Any, bool (+45 more)
...
Cohesion: 0.06
Nodes (63): setAppCheckTokenProvider(), asyncStoragePersister, DriverRootLayoutInner(), GestureRootWrapper(), incentives, MaybeStripeProvider(), parsed, questHint (+55 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (60): Any, bool, int, str, bool, str, admin_send_test_push(), create_notification() (+52 more)

### Community 25 - "Community 25"
Cohesion: 0.22
Nodes (12): float, join_quest(), _driver_row(), _progress(), _quest(), E4: 3DS payment challenge (requires_action) retry loop D10: Quest / bonus chall, Pins join_quest: creates progress; guards duplicate + full + expired.      Code, Pins join_quest: creates progress; guards duplicate + full + expired.      Cod (+4 more)
...
Cohesion: 0.05
Nodes (65): Any, str, corporate_account_row(), driver_row(), _now(), payout_row(), promotion_row(), Factory helpers for corporate-account tests.  Kept out of conftest.py because (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.19
Nodes (9): str, _driver_row(), End-to-end ride-lifecycle smoke suite.  Exercises the full happy-path a ride t, Smoke-test the routes are mounted and respond — no real DB required.      We d, Smoke-test the routes are mounted and respond — no real DB required.      We don, Canonical ride row shared by every state in the lifecycle., POST /drivers/rides/{id}/accept must transition searching → driver_accepted, _ride_row() (+1 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (19): client(), make_mock_db(), Integration tests for the quest/bonus-challenge endpoints.  Routes under test, POST /api/v1/quests/{quest_id}/join, GET /api/v1/quests/my-quests, POST /api/v1/quests/progress/{progress_id}/claim, POST /api/v1/quests/admin/create, GET /api/v1/quests/admin/list (+11 more)
...
Cohesion: 0.08
Nodes (18): client(), make_mock_db(), Integration tests for the fare-split endpoints.  Routes under test (backend/ro, POST /api/v1/fare-split, $30 split 3 ways = $10 each., GET /api/v1/fare-split/{split_id}, A user who is neither requester nor participant cannot view., GET /api/v1/fare-split/ride/{ride_id} (+10 more)
...
Cohesion: 0.27
Nodes (5): _model_to_json_dict(), Phase 5 contract test — money fields serialize as Decimal strings.  Regression, Round-trip a Pydantic model through .model_dump_json() to mirror what     FastA, Every money field on every response model must serialize as `"X.XX"`,     never, TestMoneyFieldsSerializeAsString
...
Cohesion: 0.06
Nodes (20): _app(), Tests that admin_router routes require authentication.  The router-level `Depe, A-P3-2: 5 failed logins → 423 account locked for 24 hours., A-P3-5: Only super_admin may create / update staff., A-P2-2: requests from staff idle > 30 min are rejected with 401., A-P3-1: ADMIN_PASSWORD must be compared via bcrypt, not plaintext., Verify admin routes reject unauthenticated requests., Use the TestClient from conftest. (+12 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (46): _money(), Route tests for /company/{id}/** (admin-only endpoints).  Uses `app.dependency, Compare API money values regardless of whether they are returned as     str (po, Any active member can read the policy (rider Work Profile needs it)., Inject a fake current_user for `/company/**` endpoints., Any active member can read the policy (rider Work Profile needs it)., No policy configured → empty dict, not 404., No policy configured → empty dict, not 404. (+38 more)

### Community 38 - "Community 38"
Cohesion: 0.25
Nodes (6): app_fixture(), client(), A-P2-7: Admin business logic tests.  Covers driver approve/reject/suspend/ban,, Make every test in this module run as super_admin by default., _set_super_admin(), TestAdminUserStatus
...
Cohesion: 0.14
Nodes (31): _apply_all_patches(), _fake_corporate_ride(), _fake_fare_info(), _get_rows_side_effect(), _mock_create_ride_deps(), _mock_process_payment_deps(), Tests for corporate ride payment wiring — Plans 4 & 5.  Tests for:   A. creat, No work_profile → list_active_memberships_for_user never called. (+23 more)

### Community 41 - "Community 41"
Cohesion: 0.11
Nodes (13): client(), make_mock_db(), Integration tests for the in-app wallet endpoints.  Routes under test (backend, POST /api/v1/wallet/top-up, POST /api/v1/wallet/pay, GET /api/v1/wallet/transactions, POST /api/v1/wallet/transfer, Build a mock db using the flat Supabase-style interface wallet routes use. (+5 more)

### Community 42 - "Community 42"
Cohesion: 0.13
Nodes (26): createPromotion(), deletePromotion(), getPromoStats(), getPromotions(), getPromoUsage(), updatePromotion(), DATE_RANGES, fetchAll() (+18 more)
...
Cohesion: 0.09
Nodes (28): float, int, MagicMock, str, _completed_ride(), _driver(), _rating_req(), E2E — Driver-rating regression suite (B-P0-1).  The first-rating crash was cau (+20 more)
...
Cohesion: 0.05
Nodes (66): admin_add_driver_note(), admin_assign_driver_area(), admin_delete_driver_note(), admin_driver_action(), admin_get_driver_daily_stats(), admin_get_driver_live_stats(), admin_get_driver_stats(), admin_get_drivers() (+58 more)
...
Cohesion: 0.13
Nodes (20): admin_delete_cloud_message(), admin_get_cloud_message_stats(), admin_get_cloud_messages(), admin_send_cloud_message(), _fan_out_push(), Send or schedule a cloud message to users/drivers.      Immediate sends return, Get cloud messages with optional filters., Get cloud messaging statistics. (+12 more)

### Community 53 - "Community 53"
Cohesion: 0.16
Nodes (19): AdminCancelRideRequest, str, _driver_row(), Regression tests for the driver-accept → rider-sees-update handoff.  User repo, Accepting a ride must open insurance Period 2 (en route to pickup —         TNC, The rider app's polling fallback calls GET /rides/{id} every 15 s.     Once acce, When the atomic guard returns None (ride already taken by concurrent request),, The rider app's polling fallback calls GET /rides/{id} every 15 s.     Once acc (+11 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (27): _apply_history_filter(), _FakeQuery, _FakeResult, _FakeSupabase, Regression tests for B-P1-7: ride history DB-side status filter.  Background, Confirm the per-request DB cap is 500, not the old 2000., get_ride_history must call db_supabase.get_rows with     status=$in[completed,ca, Cancelled rides with no driver_id must be filtered out in Python. (+19 more)
...
Cohesion: 0.05
Nodes (54): str, Request, str, JSONResponse, Request, Exception, RequestValidationError, Test get_current_user with invalid token. (+46 more)

### Community 57 - "Community 57"
Cohesion: 0.03
Nodes (102): str, str, _app_with_mocked_auth(), _driver_row(), _make_ride(), _patch_settings(), _patch_stripe_confirm(), P0 ship-blocker tests — pins the five highest-priority end-to-end paths called (+94 more)

### Community 58 - "Community 58"
Cohesion: 0.13
Nodes (17): Any, bool, int, str, CloudinaryService, get_cloudinary_service(), init_cloudinary(), Cloudinary Integration for Spinr Provides image upload, transformation, and man (+9 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (54): AuditLogsPage(), formatHours(), QueueStats(), QueueStatsProps, PERIODS, RevenueCard(), RidesChart(), RideStatsCards() (+46 more)

### Community 60 - "Community 60"
Cohesion: 0.10
Nodes (24): str, _admin_jwt(), B-P1-13 — pin the contract for /auth/logout-all and /admin/auth/logout-all.  T, B-P1-11: kick is best-effort. The token_version bump + refresh         revoke a, First-ever logout-all on a user row that predates the         token_version col, If we cannot bump token_version, refuse to claim success.         Per CLAUDE.md, Mint a JWT the admin handler will accept. Uses the conftest     JWT_SECRET fixt, Pin /admin/auth/logout-all behaviour. Handler lives at     backend/routes/admin/ (+16 more)

### Community 61 - "Community 61"
Cohesion: 0.16
Nodes (16): float, str, _completed_ride(), _payment_request(), E2E — Fare-collection guard (B-P0-2 regression suite).  Exercises the atomic p, The pending→processing atomic swap prevents double-charging under concurrency., Simulates two concurrent process_payment calls on the same ride.         The fi, Tip boundary checks are validated before any Stripe call. (+8 more)
...
Cohesion: 0.21
Nodes (22): Any, Decimal, str, _Numeric, _apply(), apply_adjustment(), apply_refund(), apply_topup() (+14 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (60): hasAuthToken(), SpinrApiError, createStyles(), handleBack(), handleCall(), handleQuickReply(), sendMessage(), styles (+52 more)
...
Cohesion: 0.13
Nodes (17): _driver(), Regression tests for two backend P0 fixes.  B-P0-1: rate_driver aggregation no, Driver has one 4-star ride; new 5-star → average 4.5., Driver has one 4-star ride; new 5-star → average 4.5., complete_ride writes status='completed'.  process_payment must accept     that, complete_ride writes status='completed'.  process_payment must accept     that v, Ride in 'in_progress' must raise 409., Ride in 'in_progress' must raise 409. (+9 more)
...
Cohesion: 0.19
Nodes (15): Decimal Money Arithmetic — Replace float with Python Decimal (CQ-009), Docker Hardening — Non-root user, pinned image, HEALTHCHECK, Trivy CI scan, Geofence Arrival Gating — 150m Haversine guard on driverStore (MOB-004), JWT Refresh Token Rotation — 15-min access + 30-day refresh (SEC-014, SEC-015), Database Migration Runner — backend/scripts/migrate.py (OPS-002), Mobile Test Infrastructure — Jest + 24 tests for driver/rider stores (TST-002), OTP Brute-Force Lockout — Redis-backed distributed counter (SEC-008), Race Condition Fix — Optimistic Locking for Ride Acceptance (SEC-009) (+7 more)

### Community 73 - "Community 73"
Cohesion: 0.19
Nodes (15): authStore.test.ts (admin) — 10 tests, Vitest framework, Admin Dashboard Testing Knowledge Document, Audit Gap Analysis Report (55 issues), Backend pytest suite (pytest-asyncio, 8 test files), Backend Testing Knowledge Document, Daily Audit 2026-04-11, Driver App Testing Knowledge Document, driverStore.test.ts — 20 tests for driver ride lifecycle (+7 more)

### Community 74 - "Community 74"
Cohesion: 0.19
Nodes (15): Admin Security Checklist (MFA, RBAC, Audit Logging), Audit Ground Rules — Spinr, Backend Unaudited Routes (disputes, fare_split, corporate, wallet), Canadian Market Compliance Requirements (PIPEDA, PCI-DSS, CRA), CI/CD Security Checks (TruffleHog, Trivy, pip-audit, npm-audit), CORS Origin Allowlist Checklist, Dimension 11 — Security Headers, CORS & CI Pipeline, Driver App Key Files (useDriverDashboard, driverStore, payout) (+7 more)

### Community 75 - "Community 75"
Cohesion: 0.18
Nodes (15): Backend Scalability (stateless API, Redis shared state, pagination, background workers), GPS Location Tracking (accuracy, buffer cap, batch upload), JWT Tokens (algorithm pin, secret length, expiry, version), Monetary Field Validation (Decimal only, min/max, CAD-only, server-checked), OTP Security (rate-limit, hash, lockout, constant-time compare), Ride State Machine (atomic guard, race prevention, cancellation policy), Test Coverage Thresholds (pytest ≥70%, Jest lines ≥70 functions ≥60), WebSocket Auth & Rate Limiting (first-message auth, 30 msg/s, 64KB max) (+7 more)
...
Cohesion: 0.07
Nodes (44): AreaStat, AreaStatsTable(), ChartCard(), ChartData, DriverCharts(), tooltipStyle, DriverStatsCards(), DriverStatsData (+36 more)

### Community 78 - "Community 78"
Cohesion: 0.02
Nodes (234): build_monitoring_ride(), fetch_monitoring_drivers(), fetch_monitoring_rides(), flush_redis_prefix(), FlushPrefixRequest, get_infrastructure_stats(), get_monitoring_drivers(), get_monitoring_rides() (+226 more)
...
Cohesion: 0.26
Nodes (10): AddressesScreen(), AutocompletePrediction, createStyles(), fetchAddresses(), geocodeAddress(), handleAddAddress(), handleDelete(), SavedAddress (+2 more)

### Community 83 - "Community 83"
Cohesion: 0.02
Nodes (254): create_ride(), estimate_ride(), get_call_info(), get_chat_status(), get_share_trip_link(), process_payment(), ProcessPaymentRequest, Auto-cancel a ride if it's still ``searching`` after ``timeout_seconds``.      M (+246 more)

### Community 84 - "Community 84"
Cohesion: 0.03
Nodes (93): Analytics, noop(), ConfirmPickupScreen(), createStyles(), haversineM(), StripeKeyContext, CorporateAccount, createStyles() (+85 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (39): uploadFile(), BecomeDriverScreen(), fetchRequirements(), fetchVehicleTypes(), handleSubmit(), handleUpload(), nextStep(), pickFile() (+31 more)
...
Cohesion: 0.29
Nodes (11): KYB Review Workflow (approve/reject corporate signups), Migration 27: corporate_b2b_v1.sql (9 new B2B tables), Migration 28: corporate_wallet_rpc.sql (corporate_wallet_apply_delta Postgres function), Migration 29: corporate_allowance_rpc.sql (corporate_allowance_apply_delta function), Corporate B2B Plan 1: DB Foundation + Super-admin + KYB Queue, Corporate B2B Plan 2: Master Wallet + Stripe, Corporate B2B Plan 3: Employee Allowances & Work Profile, backend/routes/corporate_wallet.py (super-admin wallet endpoints) (+3 more)

### Community 90 - "Community 90"
Cohesion: 0.02
Nodes (228): admin_reveal_setting(), Return the plaintext value of a single credential field. super_admin only. Alway, Return the plaintext value of a single credential field. super_admin only. Alway, Return the plaintext value of a single credential field. super_admin only. Alway, admin_update_dsar_status(), Update DSAR status (in_progress, completed, rejected)., Update DSAR status (in_progress, completed, rejected)., admin_report_lost_item() (+220 more)

### Community 91 - "Community 91"
Cohesion: 0.05
Nodes (128): ActivityPage(), currentMonth(), formatCAD(), POLICY_RESULT_COLORS, STATUS_COLORS, formatDate(), submitDecision(), handleExport() (+120 more)

### Community 92 - "Community 92"
Cohesion: 0.15
Nodes (12): bool, float, Token, deadline_exhausted(), get_request_deadline(), Per-request deadline propagation via a contextvar.  Clients send an `X-Deadlin, Set (or clear) the monotonic-clock deadline for this request.      `deadline_m, Return the monotonic-clock deadline for this request, or None. (+4 more)
...
Cohesion: 0.13
Nodes (6): client(), Tests for the public GET /service-areas endpoint.  Pins that:   - Active serv, A stale multiplier/active flag must not surface unless surge_enabled., Admin dashboard saves GeoJSON dicts — endpoint must normalize them., A stale multiplier/active flag must not surface unless surge_enabled., TestPublicServiceAreas

### Community 95 - "Community 95"
Cohesion: 0.04
Nodes (119): str, bytes, str, str, float, get_public_faqs(), List active FAQ entries, optionally filtered by category and audience.      Wh, get_company_info() (+111 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (26): float, int, str, _decode(), _mint(), P3-6: Admin JWT module-gating integration tests.  Admin JWTs carry a `modules`, A token with no module access is still structurally valid., The session endpoint must reflect the modules embedded in the JWT. (+18 more)

### Community 97 - "Community 97"
Cohesion: 0.04
Nodes (90): admin_close_ticket(), admin_create_complaint(), admin_create_dispute(), admin_create_ticket(), admin_deactivate_flag(), admin_delete_complaint(), admin_delete_dispute(), admin_delete_flag() (+82 more)

### Community 98 - "Community 98"
Cohesion: 0.12
Nodes (24): DriverActionRequest, DriverNoteCreate, DriverSearchRequest, DriverVerifyRequest, str, Extended unit tests for routes/admin/rides.py and routes/admin/drivers.py.  ro, _ride(), TestAdminAddDriverNote (+16 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (46): ConnectionStatus, FATAL_ERROR_MESSAGES, KNOWN_EVENT_TYPES, useMonitoringSocket(), UseMonitoringSocketOptions, AlertFeed(), AlertFeedProps, formatTime() (+38 more)
...
Cohesion: 0.06
Nodes (28): nativeModule, SafeRefreshControl(), createStyles(), PayoutHistoryScreen(), createStyles(), QUEST_TYPE_ICONS, QUEST_TYPE_LABELS, QuestsScreen() (+20 more)

### Community 104 - "Community 104"
Cohesion: 0.03
Nodes (82): defaultProps, { getAllByText }, { getByText }, initialMetrics, mockRide, mockRider, { queryByText }, renderWithSafeArea() (+74 more)

### Community 105 - "Community 105"
Cohesion: 0.06
Nodes (89): add_allowed_domain(), get_member_by_invite_token(), list_company_members(), list_pending_allowance_requests_for_member(), Any, bool, Decimal, float (+81 more)

### Community 106 - "Community 106"
Cohesion: 0.04
Nodes (109): fare_split_pay_share(), increment_promo_uses(), PostgREST treats `*` as a wildcard in (i)like filters. Escape `*` and     `,` so, Convert one {col: predicate} pair into a PostgREST or_() leaf term., Flatten a list of {col: predicate} dicts into a PostgREST or_() string., Return the first row matching filters, or None., Bulk insert using Supabase's native batch insert (single round-trip)., Atomically increment a wallet balance. Returns the new balance. (+101 more)

### Community 107 - "Community 107"
Cohesion: 0.08
Nodes (46): Any, bool, int, str, Recursively prepare a payload for Supabase/PostgREST JSON encoding., _serialize_for_api(), claim_ride_payment_processing(), create_complaint() (+38 more)
...
Cohesion: 0.05
Nodes (105): Any, str, Any, bool, int, str, Any, bool (+97 more)

### Community 111 - "Community 111"
Cohesion: 0.02
Nodes (189): _active_subs_at(), admin_bulk_retry_payouts(), admin_cancel_ride(), admin_close_payout_period(), admin_complete_ride(), admin_create_ride(), admin_export_drivers(), admin_export_filtered_rides() (+181 more)

### Community 112 - "Community 112"
Cohesion: 0.36
Nodes (6): B-P2-7: tests for the explicit DB ThreadPoolExecutor.  Contract:   - run_sync, When work is submitted, the thread name should start with     'spinr-db' — conf, run_sync must hand the function to _DB_EXECUTOR specifically,     not the defau, test_db_executor_has_explicit_size_default_32(), test_db_executor_threads_have_spinr_prefix(), test_run_sync_dispatches_to_db_executor()

### Community 113 - "Community 113"
Cohesion: 0.29
Nodes (3): PIPEDA DSAR completeness test (B-P1-9).  Asserts that the driver data-export b, _build_and_email_data_export must include all DSAR_FIELDS., TestDsarExportCompleteness

### Community 114 - "Community 114"
Cohesion: 0.10
Nodes (23): Enum, AllowanceRequestResponse, AllowanceRequestStatus, AllowanceResponse, AllowanceStatus, AllowanceType, CorporateAccountCreate, CorporateAccountUpdate (+15 more)

### Community 115 - "Community 115"
Cohesion: 0.02
Nodes (130): AccessibilityScreen(), createStyles(), formatPhoneDisplay(), handlePhoneChange(), handleSendCode(), handleCodeChange(), handleResend(), handleVerify() (+122 more)

### Community 116 - "Community 116"
Cohesion: 0.42
Nodes (9): _api(), _build_issue_body(), create_or_update_issue(), main(), Create a GitHub Issue from a CI audit report.  Only creates issues for finding, _search_existing(), Any, int (+1 more)

### Community 117 - "Community 117"
Cohesion: 0.03
Nodes (121): str, str, str, float, int, str, int, str (+113 more)

### Community 118 - "Community 118"
Cohesion: 0.09
Nodes (20): Validate a CRA Business Number format (9 digits, optional CRA program identifier, Validate a CRA Business Number format (9 digits, optional CRA program identifier, Validate a two-letter Canadian province/territory code., Validate a two-letter Canadian province/territory code., Normalize and validate an email domain for allowlist use.      Strips whitespa, Normalize and validate an email domain for allowlist use.      Strips whitespace, validate_canadian_tax_region(), validate_cra_business_number() (+12 more)
...
Cohesion: 0.07
Nodes (49): CarMapCameraState, clampDelta(), useCarMapCamera, zoomInDelta(), zoomOutDelta(), buildHandoffUrl(), BUTTON, CarRoute (+41 more)
...
Cohesion: 0.24
Nodes (11): bytes, float, str, _extract_trail(), Render a PNG snapshot of a ride's route via Google Static Maps API.  Used for: -, Convert phase_polylines entry [lat, lng, ts] to 'lat,lng' strings., OSM/staticmap fallback — used only when Google API key is unavailable., Fetch a PNG from Google Static Maps API with route drawn.      Returns PNG bytes (+3 more)

### Community 123 - "Community 123"
Cohesion: 0.13
Nodes (45): agents(), _aggregate_trends(), comment_ticket(), CommentRequest, _config_status(), create_ticket(), CreateTicketRequest, dashboard() (+37 more)

### Community 124 - "Community 124"
Cohesion: 0.12
Nodes (31): STATUS_COLORS, fetchDisputes(), fetchStats(), handleResolve(), refresh(), AllowanceRequestRow, BillingSummary, CorporateMember (+23 more)

### Community 125 - "Community 125"
Cohesion: 0.09
Nodes (83): AllowanceCreate, AllowanceRequestDecision, AllowanceUpdate, AllowedDomainCreate, get_corporate_member_by_id(), get_corporate_policy(), get_member_allowance(), list_company_ride_payment_sources() (+75 more)
...
Cohesion: 0.10
Nodes (23): Any, bool, float, int, str, _is_dispatchable_driver(), rank_by_eta_with_acceptance(), Return ``(algorithm, min_rating, search_radius_km)`` for this ride.          Rea (+15 more)
...
Cohesion: 0.15
Nodes (22): ABC, Backend Agent Specialized for Python/FastAPI backend development., Agent specialized in backend development for the Spinr platform., AgentTask, Base Agent Module Provides the foundation for all agents in the Spinr developme, Task execution status., Task structure for agent execution., TaskStatus (+14 more)
...
Cohesion: 0.09
Nodes (32): CancellationMixBar(), CeoMetricsHeader(), COMPARE_COLORS, DeltaChip(), EarningsPage(), fmtCount(), fmtHours(), fmtMoney() (+24 more)

### Community 136 - "Community 136"
Cohesion: 0.05
Nodes (73): docRequiresExpiry(), DocRow, DocumentReviewer(), DocumentReviewerProps, isPdf(), REQUIRES_EXPIRY_KEYWORDS, statusTone(), TEMPLATES (+65 more)
...
Cohesion: 0.03
Nodes (149): Any, Decimal, Request, str, bool, bool, bool, MagicMock (+141 more)

### Community 139 - "Community 139"
Cohesion: 0.15
Nodes (26): float, str, _autotopup_wallet(), _expected_autotopup_key(), Replay-safety guarantees for payment-touching background loops.  CLAUDE.md, Ba, When the conditional update returns None (another replica won     the race), th, The replica that wins the conditional update is the one that     notifies the d, The claim filter must include payment_retry_count=<prior> so two     replicas r (+18 more)

### Community 140 - "Community 140"
Cohesion: 0.11
Nodes (50): AllowanceRequestCreate, accept_member_invite(), get_corporate_account_by_id(), insert_corporate_member_invite(), list_active_memberships_for_user(), Decimal, str, Any (+42 more)
...
Cohesion: 0.47
Nodes (4): End-to-end happy path for the Plan-3 member lifecycle.  Walks the full flow th, Same current_user for admin + rider endpoints — guard/auth distinction     is m, test_full_member_lifecycle(), user_override()
...
Cohesion: 0.12
Nodes (55): bool, int, Request, Response, str, Validate generic ID format (alphanumeric with underscores/hyphens).      Args:, Validate generic ID format (alphanumeric with underscores/hyphens).      Args:, validate_id() (+47 more)
...
Cohesion: 0.07
Nodes (32): create_staff(), delete_staff(), get_staff(), list_modules(), list_staff(), List all staff members., List staff members with offset/limit pagination.      Returns a flat array (back, List staff members with offset/limit pagination.      Returns a flat array (ba (+24 more)

### Community 148 - "Community 148"
Cohesion: 0.08
Nodes (15): Any, float, int, str, error_response(), OTPExpiredException, Convert exception to dictionary for JSON response., Convert exception to dictionary for JSON response. (+7 more)

### Community 149 - "Community 149"
Cohesion: 0.50
Nodes (6): _build_cr(), generate(), main(), Generate structured Change Request drafts from fix recommendations.  These CRs, Any, str
...
Cohesion: 0.14
Nodes (14): str, object, str, TestLoopMonitor, check_and_alert(), Background loop staleness alerter.  Reads loop heartbeat state from loop_monit, Check loop staleness and post alerts for newly-stale loops.      Args:, get_loop_status() (+6 more)

### Community 153 - "Community 153"
Cohesion: 0.10
Nodes (18): JWT_SECRET shorter than 32 chars must raise in production., 32-char JWT_SECRET + both Firebase IDs → no exception., Exactly 32 chars is the minimum — must not raise., JWT_SECRET shorter than 32 chars must raise in production., Empty FIREBASE_DRIVER_APP_ID must raise in production., Exactly 32 chars is the minimum — must not raise., Empty FIREBASE_RIDER_APP_ID must raise in production., Empty FIREBASE_DRIVER_APP_ID must raise in production. (+10 more)
...
Cohesion: 0.04
Nodes (71): str, add_tip(), _build_fare_breakdown(), cancel_ride_rider(), _d(), _f(), get_ride_history(), get_ride_receipt() (+63 more)
...
Cohesion: 0.05
Nodes (50): ActiveRide, DailyEarning, DriverState, EarningsSummary, IncomingRide, RideState, TripEarning, useDriverStore (+42 more)

### Community 162 - "Community 162"
Cohesion: 0.04
Nodes (45): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟠 [P1] TEST — `backend-test`, 4. 🟠 [P1] BUILD — `backend-test`, 5. 🟠 [P1] TEST — `rider-app-test`, 6. 🟠 [P1] BUILD — `rider-app-test`, 7. 🟠 [P1] TEST — `admin-test`, Audit Metadata (+37 more)
...
Cohesion: 0.06
Nodes (40): float, _is_corporate_paid(), True when the ride will be settled against a corporate account.      Surge does, True when the ride will be settled against a corporate account.      Surge does, True when the ride will be settled against a corporate account.      Surge doe, _patch_create_ride_deps(), _patch_estimate_deps(), Surge-bypass guarantees for corporate-paid rides.  CLAUDE.md, Surge pricing ru (+32 more)
...
Cohesion: 0.40
Nodes (4): Test the admin endpoints we just implemented, test_admin_endpoints(), Test the admin endpoints we just implemented, test_admin_endpoints()

### Community 173 - "Community 173"
Cohesion: 0.17
Nodes (15): actual, badgeStub, cardStubs, dialogStubs, list, noop, overrides, pageSubComponentStub() (+7 more)
...
Cohesion: 0.04
Nodes (44): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟠 [P1] TEST — `admin-test`, 4. 🟡 [P2] LINT — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, 6. 🟠 [P1] BUILD — `security-scan`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)

### Community 177 - "Community 177"
Cohesion: 0.05
Nodes (64): BarStat(), DashboardPage(), MiniCard(), RevenueCard(), STAT_COLOR_CLASSES, StatCard(), Stats, createAreaFee() (+56 more)

### Community 178 - "Community 178"
Cohesion: 0.04
Nodes (44): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] BUILD — `security-scan`, 3. 🟡 [P2] LINT — `backend-test`, 4. 🟠 [P1] BUILD — `backend-test`, 5. 🟠 [P1] TEST — `driver-app-test`, 6. 🟠 [P1] BUILD — `driver-app-test`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)
...
Cohesion: 0.14
Nodes (23): Any, Exception, float, str, Tests for the Redis connectivity diagnostic (Upstash debugging helper)., An Upstash REST URL (https) can't do pub/sub — flag it without a socket., Two labels pointing at the same URL should be marked as shared, not     dialed, test_diagnose_dedupes_shared_url() (+15 more)

### Community 181 - "Community 181"
Cohesion: 0.04
Nodes (44): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] BUILD — `security-scan`, 3. 🟠 [P1] TEST — `driver-app-test`, 4. 🟠 [P1] BUILD — `driver-app-test`, 5. 🟡 [P2] LINT — `backend-test`, 6. 🟠 [P1] BUILD — `backend-test`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)

### Community 182 - "Community 182"
Cohesion: 0.04
Nodes (44): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟠 [P1] TEST — `admin-test`, 4. 🟠 [P1] BUILD — `security-scan`, 5. 🟡 [P2] LINT — `backend-test`, 6. 🟠 [P1] BUILD — `backend-test`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)
...
Cohesion: 0.04
Nodes (44): 1. 🟡 [P2] LINT — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, 3. 🟠 [P1] TEST — `driver-app-test`, 4. 🟠 [P1] BUILD — `driver-app-test`, 5. 🟠 [P1] TEST — `admin-test`, 6. 🟠 [P1] BUILD — `security-scan`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)

### Community 187 - "Community 187"
Cohesion: 0.04
Nodes (44): 1. 🟠 [P1] BUILD — `security-scan`, 2. 🟡 [P2] LINT — `backend-test`, 3. 🟠 [P1] BUILD — `backend-test`, 4. 🟠 [P1] TEST — `admin-test`, 5. 🟠 [P1] TEST — `driver-app-test`, 6. 🟠 [P1] BUILD — `driver-app-test`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)
...
Cohesion: 0.02
Nodes (116): ApiErrorBody, ApiErrorLogEntry, appCheckHeader(), clearApiErrorLog(), deadlineHeader(), ensureFreshToken(), _errorLog, ExtractedError (+108 more)
...
Cohesion: 0.04
Nodes (44): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟡 [P2] LINT — `backend-test`, 3. 🟠 [P1] BUILD — `backend-test`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, 6. 🟠 [P1] BUILD — `security-scan`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)

### Community 195 - "Community 195"
Cohesion: 0.04
Nodes (44): 1. 🟡 [P2] LINT — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, 3. 🟠 [P1] BUILD — `security-scan`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, 6. 🟠 [P1] TEST — `admin-test`, 7. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata (+36 more)
...
Cohesion: 0.15
Nodes (13): 1. Cloudinary Integration, 2. Mixpanel/Amplitude Analytics, code:python (from backend.utils.cloudinary import init_cloudinary, get_cl), code:bash (CLOUDINARY_CLOUD_NAME=your-cloud-name), code:python (from backend.utils.analytics import init_analytics, get_anal), code:bash (MIXPANEL_TOKEN=your-mixpanel-token), Environment Variables, Environment Variables (+5 more)
...
Cohesion: 0.06
Nodes (44): _check_license_plate(), _check_vehicle_year(), _check_vin(), int, bool, datetime, Decimal, float (+36 more)
...
Cohesion: 0.13
Nodes (15): queryClient, queryKeys, DriverStackLayout(), createStyles(), handleNotificationPress(), markAsRead(), Notification, NotificationsScreen() (+7 more)
...
Cohesion: 0.10
Nodes (27): str, Any, float, str, _patch_settings(), _patch_stripe(), Unit tests for backend/utils/stripe_charge.py::charge_ride().  charge_ride() i, Float 19.999 must round to 2000 cents, not 1999 or 2001. (+19 more)

### Community 211 - "Community 211"
Cohesion: 0.13
Nodes (11): Areas with surge_source='manual' are never updated., When new multiplier differs from stored, update_one IS called., An exception processing one area logs error but continues to next area., Every processed area gets a surge_pricing history row inserted., test_recalculate_area_failure_does_not_abort_remaining(), test_recalculate_inserts_surge_pricing_history_row(), test_recalculate_skips_manual_override_areas(), test_recalculate_updates_db_when_multiplier_changes() (+3 more)

### Community 213 - "Community 213"
Cohesion: 0.05
Nodes (41): code:bash (# Backend health), code:python (@router.post("/rides/{ride_id}/rate")), code:typescript (// rider-app/utils/attemptRidePayment.ts), code:python (# backend/utils/cookie_manager.py (new file)), code:bash (pytest backend/tests/test_cookie_auth.py -v), code:typescript (// rider-app/utils/apiClient.ts), code:bash (# Dev: run app, login, check browser Network tab), code:bash (# Check for auth errors) (+33 more)

### Community 214 - "Community 214"
Cohesion: 0.15
Nodes (13): 13. Two push-token endpoints, only one used, 14. Two driver-status endpoints, 15. Two account-deletion endpoints — driver is using the wrong one (PIPEDA risk), 16. Driver destination zone (commute home), 17. Driver leaderboard, 18. Driver document delete, 19. `is_available` toggle, Driver App ↔ Backend Integration Audit (+5 more)
...
Cohesion: 0.08
Nodes (45): CATEGORIES, DriverNotes(), fmtDateTime(), handleAdd(), handleDelete(), loadNotes(), handleDone(), addDriverNote() (+37 more)
...
Cohesion: 0.05
Nodes (39): 1. 🟠 [P1] TEST — `rider-app-test`, 2. 🟠 [P1] BUILD — `rider-app-test`, 3. 🟠 [P1] BUILD — `backend-test`, 4. 🟠 [P1] TEST — `admin-test`, 5. 🟠 [P1] TEST — `driver-app-test`, 6. 🟠 [P1] BUILD — `driver-app-test`, Audit Metadata, CI Error Audit Report (+31 more)

### Community 228 - "Community 228"
Cohesion: 0.11
Nodes (17): Agent Framework (`agents/`), Background Loop Recipe, Claude-Adjacent Directories, code:python (# backend/utils/my_loop.py), Compliance (PIPEDA), Context Imports, Database & Migration Conventions, Deployment (+9 more)

### Community 229 - "Community 229"
Cohesion: 0.15
Nodes (13): 1. Stripe Refund Implementation - disputes.py (Line 160-165), 2. Missing Admin Authorization - disputes.py (Line 139-167), 3. Promo Code Race Condition - promotions.py (Line 141-146), 4. Missing Validation for Negative Values - promotions.py (Line 34), 5. Arbitrary Code Injection in Notification Types - notifications.py (Line 27), code:python (# If approved, initiate refund via Stripe (stub for now)), code:python (@admin_router.put("/{dispute_id}/resolve")), code:python (promo = await db.promo_codes.find_one({"id": validation["pro) (+5 more)

### Community 230 - "Community 230"
Cohesion: 0.15
Nodes (12): Action Items Checklist, Admin Dashboard, Backend Tests, Estimated Work to Release-Ready, Executive Summary, Mobile Apps, Must Do Before Testing, Project Components Analyzed (+4 more)
...
Cohesion: 0.13
Nodes (25): str, _make_driver(), _make_ride(), Tests for utils/t4a_annual_job.py — P4-7 CRA T4A annual issuance loop.  Covers, No drivers above threshold — no pushes, audit still written., Drivers missing user_id are skipped silently., Push failure for one driver doesn't abort the rest., Does nothing on a day that is not last-day-of-February. (+17 more)

### Community 233 - "Community 233"
Cohesion: 0.10
Nodes (35): Decimal, str, str, cancel_fare_split(), create_fare_split(), CreateFareSplitRequest, _d(), get_fare_split() (+27 more)

### Community 234 - "Community 234"
Cohesion: 0.15
Nodes (16): list_users(), make_admin(), str, str, Tests for ``backend.utils.pii`` PIPEDA redaction helpers.  These helpers are m, test_redact_email_masks_local_part(), test_redact_email_never_leaks_local_beyond_first_char(), test_redact_email_rejects_malformed() (+8 more)

### Community 235 - "Community 235"
Cohesion: 0.14
Nodes (8): _driver(), Regression: `email` lives on `users`, not `drivers`. Writing it to         `dri, first_name/last_name are mirrored on both tables; the legacy         `drivers.n, An orphaned driver (no user_id) must still be editable for fields         mirro, Ordering guard: the canonical users row is written before the         drivers m, TestAdminGetDrivers, TestAdminUpdateDriver, _user()

### Community 236 - "Community 236"
Cohesion: 0.09
Nodes (23): 10. Start Ride, 11. Complete Ride, 12. Ride History & Earnings, 1. Authentication Flow, 2. Ride State Machine, 3. Location Tracking, 4. WebSocket Connection, 5. Ride Offer Flow (+15 more)
...
Cohesion: 0.08
Nodes (25): buildPlacesQuery(), PlaceBias, PlaceDetails, PlacePrediction, PlacesAutocompleteQuery, StructuredFormatting, createStyles(), handleSave() (+17 more)

### Community 246 - "Community 246"
Cohesion: 0.02
Nodes (120): float, str, str, AppSettings, DeprecatedRootPathMiddleware, health(), _loguru_sentry_sink(), metrics() (+112 more)

### Community 247 - "Community 247"
Cohesion: 0.05
Nodes (47): FastAPI, str, TestClient, bool, str, CSRFMiddleware, init_middleware(), Double-submit cookie CSRF protection for state-changing requests.      Only enfo (+39 more)
...
Cohesion: 0.33
Nodes (25): BackendAgent, CodeReviewerAgent, DeploymentAgent, DocumentationAgent, FrontendAgent, Spinr Development Agents System A hierarchical, autonomous agent system for dev, KnowledgeBaseAgent, AgentRegistry (+17 more)
...
Cohesion: 0.16
Nodes (20): Decimal, str, admin_create_quest(), admin_update_quest(), claim_quest_reward(), CreateQuestRequest, _d(), _f() (+12 more)

### Community 253 - "Community 253"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] BUILD — `backend-test`, 2. 🟠 [P1] BUILD — `security-scan`, 3. 🟠 [P1] TEST — `rider-app-test`, 4. 🟠 [P1] BUILD — `rider-app-test`, 5. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T05:57:24.7895499Z Could not pull latest version i) (+26 more)

### Community 254 - "Community 254"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `rider-app-test`, 2. 🟠 [P1] BUILD — `rider-app-test`, 3. 🟠 [P1] BUILD — `security-scan`, 4. 🟠 [P1] BUILD — `backend-test`, 5. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T05:58:48.7918390Z FAIL store/__tests__/rideStore.) (+26 more)

### Community 255 - "Community 255"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `rider-app-test`, 2. 🟠 [P1] BUILD — `rider-app-test`, 3. 🟠 [P1] BUILD — `backend-test`, 4. 🟠 [P1] BUILD — `security-scan`, 5. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T06:09:47.8141079Z FAIL store/__tests__/rideStore.) (+26 more)

### Community 256 - "Community 256"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] TEST — `driver-app-test`, 3. 🟠 [P1] BUILD — `driver-app-test`, 4. 🟡 [P2] LINT — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T12:58:01.5423082Z FAIL __tests__/store/authStore.) (+26 more)

### Community 257 - "Community 257"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟡 [P2] LINT — `backend-test`, 3. 🟠 [P1] BUILD — `backend-test`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T13:03:55.7328764Z Found 11 errors.) (+26 more)

### Community 258 - "Community 258"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟡 [P2] LINT — `backend-test`, 4. 🟠 [P1] BUILD — `backend-test`, 5. 🟠 [P1] TEST — `admin-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T13:29:21.2594220Z FAIL __tests__/store/authStore.) (+26 more)

### Community 259 - "Community 259"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] TEST — `driver-app-test`, 3. 🟠 [P1] BUILD — `driver-app-test`, 4. 🟡 [P2] LINT — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T13:31:48.2257971Z FAIL __tests__/store/authStore.) (+26 more)

### Community 260 - "Community 260"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟠 [P1] TEST — `admin-test`, 4. 🟡 [P2] LINT — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T13:35:55.1741855Z FAIL __tests__/store/authStore.) (+26 more)
...
Cohesion: 0.15
Nodes (25): _connected_config(), _FakeClient, _FakeResponse, _patch_db(), _patch_http(), Unit tests for the Zoho Desk integration (services/zoho_desk_service.py).  Cov, Async-context-manager stand-in for httpx.AsyncClient. ``handler`` is a     call, test_401_triggers_single_refresh_retry() (+17 more)

### Community 265 - "Community 265"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟡 [P2] LINT — `backend-test`, 4. 🟠 [P1] BUILD — `backend-test`, 5. 🟠 [P1] TEST — `admin-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T14:39:39.2788727Z FAIL __tests__/store/authStore.) (+26 more)

### Community 266 - "Community 266"
Cohesion: 0.06
Nodes (34): 1. 🟡 [P2] LINT — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, 3. 🟠 [P1] TEST — `admin-test`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T15:33:15.3827094Z Found 11 errors.) (+26 more)

### Community 267 - "Community 267"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] TEST — `driver-app-test`, 3. 🟠 [P1] BUILD — `driver-app-test`, 4. 🟡 [P2] LINT — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T15:35:23.1777035Z FAIL __tests__/store/authStore.) (+26 more)

### Community 268 - "Community 268"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟠 [P1] TEST — `admin-test`, 4. 🟡 [P2] LINT — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T15:34:25.6315861Z FAIL __tests__/store/authStore.) (+26 more)

### Community 269 - "Community 269"
Cohesion: 0.06
Nodes (34): 1. 🟡 [P2] LINT — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, 3. 🟠 [P1] TEST — `driver-app-test`, 4. 🟠 [P1] BUILD — `driver-app-test`, 5. 🟠 [P1] TEST — `admin-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-29T01:47:03.7961568Z Found 11 errors.) (+26 more)

### Community 270 - "Community 270"
Cohesion: 0.06
Nodes (34): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] TEST — `driver-app-test`, 3. 🟠 [P1] BUILD — `driver-app-test`, 4. 🟠 [P1] TEST — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-29T03:25:52.8121697Z ##[error]AssertionError: promis) (+26 more)
...
Cohesion: 0.29
Nodes (7): nextConfig, securityHeaders, AuthInitializer(), PUBLIC_PREFIXES, isTrackingHost(), TRACK_CSP, trackingHosts()

### Community 277 - "Community 277"
Cohesion: 0.10
Nodes (16): bool, str, Direct unit tests for ``backend/utils/crypto.py``.  Covers the OTP-hashing hel, Boundary inputs the auth code might plausibly pass through., ``hash_otp`` must be a pure SHA-256 of the OTP bytes — no salt, no nonce., ``verify_otp_hash`` returns True only for the matching OTP., Verification MUST go through ``hmac.compare_digest``.      Plain ``==`` short-, TestEdgeCases (+8 more)

### Community 279 - "Community 279"
Cohesion: 0.04
Nodes (62): str, str, get_ride_messages(), Fetch persistent chat messages for a ride, Fetch persistent chat messages for a ride, Fetch persistent chat messages for a ride, Send a chat message for an active or recently completed ride.      Persists the, Send a chat message for an active or recently completed ride.      Persists the (+54 more)
...
Cohesion: 0.06
Nodes (33): 1. 🟠 [P1] TEST — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, 3. 🟠 [P1] TEST — `admin-test`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T14:54:54.0182642Z ERROR tests/test_p1_auth_harden) (+25 more)

### Community 287 - "Community 287"
Cohesion: 0.06
Nodes (33): 1. 🟠 [P1] TEST — `driver-app-test`, 2. 🟠 [P1] BUILD — `driver-app-test`, 3. 🟠 [P1] TEST — `backend-test`, 4. 🟠 [P1] BUILD — `backend-test`, 5. 🟠 [P1] TEST — `admin-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T15:27:12.5885691Z FAIL __tests__/store/authStore.) (+25 more)

### Community 289 - "Community 289"
Cohesion: 0.06
Nodes (33): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] TEST — `backend-test`, 3. 🟠 [P1] BUILD — `backend-test`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T16:04:49.8086053Z = 79 failed, 896 passed, 4 skip) (+25 more)

### Community 292 - "Community 292"
Cohesion: 0.06
Nodes (33): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] TEST — `backend-test`, 3. 🟠 [P1] BUILD — `backend-test`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T16:40:24.1709715Z = 79 failed, 896 passed, 4 skip) (+25 more)

### Community 293 - "Community 293"
Cohesion: 0.06
Nodes (33): 1. 🟠 [P1] TEST — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, 3. 🟠 [P1] TEST — `admin-test`, 4. 🟠 [P1] TEST — `driver-app-test`, 5. 🟠 [P1] BUILD — `driver-app-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T18:37:33.3382589Z = 79 failed, 896 passed, 4 skip) (+25 more)

### Community 294 - "Community 294"
Cohesion: 0.06
Nodes (33): 1. 🟠 [P1] TEST — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, 3. 🟠 [P1] TEST — `driver-app-test`, 4. 🟠 [P1] BUILD — `driver-app-test`, 5. 🟠 [P1] TEST — `admin-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T19:20:05.9930084Z = 75 failed, 900 passed, 4 skip) (+25 more)

### Community 295 - "Community 295"
Cohesion: 0.06
Nodes (33): 1. 🟠 [P1] TEST — `admin-test`, 2. 🟠 [P1] TEST — `driver-app-test`, 3. 🟠 [P1] BUILD — `driver-app-test`, 4. 🟠 [P1] TEST — `backend-test`, 5. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-29T03:44:16.6073085Z FAIL __tests__/store/authStore.) (+25 more)
...
Cohesion: 0.11
Nodes (25): Decimal, int, str, Decimal, int, Decimal, Money, Pin Decimal correctness for dollar↔cent conversions.  These tests document the (+17 more)
...
Cohesion: 0.06
Nodes (31): 1. 🟠 [P1] BUILD — `security-scan`, 2. 🟠 [P1] BUILD — `deploy-frontend`, 3. 🟠 [P1] BUILD — `docker-image-scan`, 4. 🟠 [P1] TEST — `E2E tests (Playwright)`, 5. 🟠 [P1] BUILD — `deploy-backend`, Audit Metadata, CI Error Audit Report, code:bash (docker build -f backend/Dockerfile .) (+23 more)

### Community 315 - "Community 315"
Cohesion: 0.10
Nodes (44): AgentMessage, AgentMessage, AgentStatus, KnowledgeEntry, Entry structure for knowledge base., Agent operational status., Task priority levels., Message structure for inter-agent communication. (+36 more)

### Community 316 - "Community 316"
Cohesion: 0.06
Nodes (31): 1. 🟠 [P1] BUILD — `security-scan`, 2. 🟠 [P1] BUILD — `deploy-frontend`, 3. 🟠 [P1] BUILD — `docker-image-scan`, 4. 🟠 [P1] BUILD — `deploy-backend`, 5. 🟠 [P1] TEST — `E2E tests (Playwright)`, Audit Metadata, CI Error Audit Report, code:bash (docker build -f backend/Dockerfile .) (+23 more)
...
Cohesion: 0.10
Nodes (21): admin_get_approval_queue(), admin_get_driver_activity(), admin_get_driver_location_trail(), admin_get_driver_payouts_summary(), admin_get_expiring_documents(), Get full activity timeline for a driver, newest first., Get full activity timeline for a driver, newest first., Get full activity timeline for a driver, newest first. (+13 more)

### Community 337 - "Community 337"
Cohesion: 0.11
Nodes (29): execute_task(), generate_report(), list_agents(), main(), query_knowledge(), CLI Interface for Spinr Development Agents Allows Cline and developers to inter, Execute a task through the agent system., List all registered agents. (+21 more)

### Community 338 - "Community 338"
Cohesion: 0.03
Nodes (46): _extract_signed_url(), Any, Pull the URL out of supabase-py's create_signed_url() response, tolerating     b, Pull the URL out of supabase-py's create_signed_url() response, tolerating     b, Pull the URL out of supabase-py's create_signed_url() response, tolerating, Unit tests for document management functionality. Tests cover document requirem, Sample driver document data., Test uploading a driver document. (+38 more)
...
Cohesion: 0.16
Nodes (24): _client_factory(), _empty_settings(), _FakeClient, _FakeResp, _osrm_payload(), Tests for the OSRM /match road provider (distance + geometry) and selection., compute_road_distance_km stays back-compat: distance float or None., Minimal async-context httpx.AsyncClient stand-in. (+16 more)

### Community 342 - "Community 342"
Cohesion: 0.04
Nodes (37): bool, int, JSONResponse, Request, str, RateLimitExceeded, Test RedisRateLimiter using its in-memory fallback path.      We do NOT need a, is_rate_limited returns memory result when _get_redis returns 'memory'. (+29 more)

### Community 343 - "Community 343"
Cohesion: 0.11
Nodes (18): Receipt rendering — regulatory and reconciliation guarantees.  These tests pin, Fees that calculated to $0.00 (e.g. night fee outside hours)         should not, Auto surge cap is 2.5× — must still disclose., Persisted grand_total excludes tip; receipt total adds it back., 0.29 — the canonical int(0.29*100)=28 underflow — must round-trip         throu, A minimal completed-ride dict with sane defaults., GST (5%) and PST (6%) must each get their own row — regulatory., Combined-tax provinces (e.g. Ontario HST 13%) render a single line. (+10 more)
...
Cohesion: 0.13
Nodes (17): int, str, Pins retry_failed_payments for the Stripe requires_action / 3DS path.      Cod, If the PaymentIntent already succeeded (webhook missed), mark paid., Return the first update_one call whose $set[key] == value., PaymentIntent needs confirmation → confirm() called, status=processing., If the PaymentIntent already succeeded (webhook missed), mark paid., A cancelled PaymentIntent should not be retried — cap at MAX_RETRIES. (+9 more)
...
Cohesion: 0.05
Nodes (60): Any, Decimal, float, int, str, str, build_default_fares(), build_fare_breakdown_lines() (+52 more)
...
Cohesion: 0.18
Nodes (14): ActivityView(), parseMoney(), Period, StatusFilter, styles, toMoney(), { getByText }, { getByText, queryByText } (+6 more)
...
Cohesion: 0.09
Nodes (19): str, P2-17: Scheduled rides + DST (R3, E14)  Implemented endpoints:   GET  /rides/, Pins cancel_scheduled_ride: owner guard, status update, guards.      Code unde, Ride lookup includes rider_id + is_scheduled filter;         wrong owner or non, E14 — scheduled ride times and DST boundary handling., A ride stored with an explicit UTC ISO timestamp is retrieved as-is.         No, E14 — scheduled ride times and DST boundary handling., A ride stored with an explicit UTC ISO timestamp is retrieved as-is.         No (+11 more)
...
Cohesion: 0.15
Nodes (7): int, Cover lines 120-121 — corporate topup marks processed and returns scope., Webhook arrives after the synchronous /process-payment call timed out.      Th, TestStripeWebhookCheckoutSession, TestStripeWebhookCorporateTopupSuccess, TestStripeWebhookPaymentIntentSucceeded, TestWebhookTimeoutDivergence
...
Cohesion: 0.12
Nodes (18): admin_get_driver_rides(), _batch_fetch_drivers_and_users(), Get rides for a driver, enriched with rider_name for the admin slideout.      Th, Get rides for a driver, enriched with rider_name for the admin slideout.      Th, Get rides for a driver, enriched with rider_name for the admin slideout., Batch-fetch drivers and users in 2-3 queries instead of N+1 loops., Batch-fetch drivers and users in 2-3 queries instead of N+1 loops., Get rides for a driver with pagination (max 500 per page). (+10 more)

### Community 374 - "Community 374"
Cohesion: 0.15
Nodes (24): admin_export_users(), admin_get_user_details(), admin_get_users(), admin_list_dsars(), admin_search_users(), admin_update_user_flags(), admin_update_user_status(), _mask_email() (+16 more)

### Community 375 - "Community 375"
Cohesion: 0.11
Nodes (19): Architecture Overview, Authentication Flow:, code:mermaid (graph TB), code:mermaid (erDiagram), Conclusion, Critical Issues:, Current Implementation:, Database Schema (PostgreSQL) (+11 more)

### Community 376 - "Community 376"
Cohesion: 0.11
Nodes (22): update_ride(), client(), driver_1_headers(), driver_2_headers(), Unit tests for rides API and related functionality. Tests cover ride creation,, Walk the complete ride state machine: accept → arrive → verify-otp → complete., Walk the complete ride state machine: accept → arrive → verify-otp → complete., Two simultaneous accept calls for the same ride: one wins (200), one is rejected (+14 more)

### Community 377 - "Community 377"
Cohesion: 0.30
Nodes (14): Any, datetime, str, close_linked_records(), When Zoho tickets close, close the linked Spinr records (reverse sync).      C, _map_ticket(), _name(), _parse() (+6 more)
...
Cohesion: 0.16
Nodes (18): int, str, delete_favorite_route(), get_favorite_routes(), Favorite routes — save and reuse frequent pickup→dropoff routes.  Riders can s, Increment use count when rider books from a favorite. Returns the route data., Remove a favorite route., Remove a favorite route. (+10 more)
...
Cohesion: 0.04
Nodes (88): Any, Decimal, float, Request, str, bool, Decimal, float (+80 more)

### Community 382 - "Community 382"
Cohesion: 0.15
Nodes (27): int, MagicMock, Decimal, str, _make_async_client_mock(), _make_mock_response(), Unit tests for send_ride_receipt_email.  Covers: - Early return when resend_a, GST (5%) and grand_total in the POST body must use correct Decimal arithmetic. (+19 more)
...
Cohesion: 0.15
Nodes (20): int, str, _maybe_run_tick(), Daily Stripe ↔ DB ↔ wallet reconciliation loop.  Runs once per day (aligned to, Return total succeeded PaymentIntent amount in cents for the given UTC date., Return sum of delta_cents in financial_events for the given date and type., Return sum of delta_cents in financial_events for the given date and type., Write a reconciliation_discrepancies row for ops follow-up. (+12 more)
...
Cohesion: 0.06
Nodes (32): RideOTPRequest, Sample ride creation request data., Test successful ride creation., Test ride creation with promo code., Test updating ride status., Test updating ride with driver assignment., Test completing a ride., Test cancelling a ride. (+24 more)
...
Cohesion: 0.20
Nodes (9): 🎯 Action Items Summary, Completed Today:, Comprehensive Code Gap Analysis - SpinrApp, Executive Summary, ✅ Google Maps & Places API Integration - COMPLETE, Recommended Next Steps:, 🚨 Remaining Issues (21 TypeScript Errors), 📋 Summary (+1 more)
...
Cohesion: 0.20
Nodes (12): MagicMock, BaseSettings, Settings, _noop_limit_factory(), Regression tests for backend P1 auth-hardening items.  B-P1-1: FIREBASE_DRIVER, Short JWT_SECRET is permitted outside production (dev/test)., Short JWT_SECRET is permitted outside production (dev/test)., When the DB write fails during Firebase auth, the endpoint must raise     HTTPEx (+4 more)
...
Cohesion: 0.05
Nodes (32): bool, float, int, str, WebSocket, Count active sockets on THIS replica, bucketed by client type.          Keys a, Record an inbound WebSocket message for ``user_id`` against         the per-user, Record an inbound WebSocket message for ``user_id`` against         the per-user (+24 more)
...
Cohesion: 0.07
Nodes (25): MagicMock, str, _mock_supabase_rpc_once_then_fail(), P3-4: Concurrent wallet debit tests.  The wallet_pay_for_ride and fare_split_p, RPC exception containing 'wallet not found' → ValueError., Two concurrent debits on a wallet that can only cover one:         the mock mir, Three concurrent debits, only one can win — mirrors a burst retry., The route must surface the ValueError as HTTP 400, not 500. (+17 more)
...
Cohesion: 0.11
Nodes (19): FastAPI, TestClient, _build_promo_app(), _enable_real_limiter(), Promo code endpoint rate-limit enforcement tests.  Limits (from backend/utils/, Rate-limit enforcement for POST /promo/validate (promo_validate_limit: 10/min)., 10 requests within a minute should all succeed (200 or 4xx from         busines, The 11th request within the same minute window must return 429         with the (+11 more)
...
Cohesion: 0.08
Nodes (24): 1. 🟠 [P1] BUILD — `backend-test`, 2. 🟠 [P1] TEST — `rider-app-test`, 3. 🟠 [P1] BUILD — `rider-app-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T05:58:01.2729148Z Could not pull latest version i), code:bash (cd admin-dashboard && npm run build), code:bash (cd rider-app && yarn build:web) (+16 more)
...
Cohesion: 0.22
Nodes (10): FastAPI, cleanup_database(), init_database(), lifespan(), Initialize database connection and verify it is reachable.      The supabase-p, Cleanup database connections on shutdown., Manage application lifespan events, configure_stripe() (+2 more)

### Community 423 - "Community 423"
Cohesion: 0.08
Nodes (19): Pure function: pick one driver from ``drivers_with_distance``.      ``last_assig, Pure function: pick one driver from ``drivers_with_distance``.      ``last_ass, Pure function: pick one driver from ``drivers_with_distance``.      ``last_assig, select_driver_by_algorithm(), _make_db(), Tests for DispatchService.  Exercises the pure helpers directly and the class, Combined applies rating floor in filter step, then picks nearest., If the last driver isn't in the current pool (e.g. went offline),         start (+11 more)

### Community 425 - "Community 425"
Cohesion: 0.21
Nodes (7): Pin the rider-side cancel state guard (_require_ride_in_state_rider).      The, Critical invariant: in_progress → cancelled MUST be rejected with 409., Completing an in_progress ride must pass the state guard., Cancel must succeed when ride is in searching state., Cancel must succeed when a driver has been assigned but trip not started., Cancel must be rejected with 409 when ride is already completed., TestCancelStateGuardRider

### Community 427 - "Community 427"
Cohesion: 0.14
Nodes (14): 10. Scheduled Rides Missing Reminder Logic, 6. No Dispute Evidence/Attachments Support, 7. Missing Dispute Deadline/Expiry, 8. Push Notification Delivery Not Implemented, 9. Notification Preferences Not Enforced, CODE REVIEW REPORT: Uncommitted Changes - spinrApp, Executive Summary, FILES REVIEWED (+6 more)
...
Cohesion: 0.10
Nodes (16): str, _make_stripe_event(), Tests for routes/webhooks.py and routes/main.py.  webhooks.py is at 15.9% — th, When update_ride returns None (ride not found), handler raises 500 so Stripe ret, TestAllowedStripeEvents, TestStripeWebhookCheckoutNotPaid, TestStripeWebhookClaimException, TestStripeWebhookDuplicateEvent (+8 more)
...
Cohesion: 0.04
Nodes (46): Admin (50+ endpoints), Admin Dashboard, API Endpoints (100+), Authentication, Business Model, CI/CD Pipeline, code:block1 (┌─────────────┐), code:block2 (spinr/) (+38 more)
...
Cohesion: 0.18
Nodes (13): float, str, str, _driver_row(), P1-9: Multi-stop E2E (R11)  The backend supports adding and removing stops on, Adding a stop should trigger a fare recalculation., Pins remove_stop_mid_trip: stop removed by index, driver notified.      Code u, Pins add_stop_mid_trip: stop appended, driver notified via WS.      Code under (+5 more)
...
Cohesion: 0.04
Nodes (63): log, CATEGORY_ICONS, createStyles(), LostAndFoundScreen(), LostFoundCase, STATUS_COLORS, STATUS_LABELS, createStyles() (+55 more)
...
Cohesion: 0.15
Nodes (22): Exception, MagicMock, LogCaptureFixture, _fake_supabase(), Unit tests for backend.utils.insurance_periods (M-5b).  Compliance-grade audit, A boom from the DB layer must never propagate — caller doesn't see it., Race / no-op transition: insert hits 23505 and close affected 0 rows., Driver goes offline while period 2 is open (ride in driver_assigned).     The p (+14 more)
...
Cohesion: 0.15
Nodes (12): 13. Two push-token endpoints, only one used, 14. Two driver-status endpoints, 15. Two account-deletion endpoints — driver is using the wrong one (PIPEDA risk), Driver App ↔ Backend Integration Audit, Driver → Server, Missing WS-level features on driver side, P2 — Dual / redundant endpoints that cause confusion, Recommended immediate actions (in order) (+4 more)

### Community 491 - "Community 491"
Cohesion: 0.15
Nodes (13): 1. Bug: clearRide() Now Clears Stops Array ✅, 2. Duplicate Screen Registration ✅, 3. Unused Code in search-destination.tsx ✅, 🎯 Action Items Summary, Completed Today:, Comprehensive Code Gap Analysis - SpinrApp, Executive Summary, ✅ Google Maps & Places API Integration - COMPLETE (+5 more)

### Community 492 - "Community 492"
Cohesion: 0.21
Nodes (19): Any, Decimal, float, str, _build_fare_rows(), _d(), _fmt(), _line() (+11 more)
...
Cohesion: 0.09
Nodes (21): 1. 🟠 [P1] TEST — `backend-test`, 2. 🟠 [P1] BUILD — `security-scan`, 3. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata, CI Error Audit Report, code:bash (pytest <test_path> -v), code:bash (pytest -v), code:bash (docker build -f backend/Dockerfile .) (+13 more)

### Community 514 - "Community 514"
Cohesion: 0.09
Nodes (21): 1. 🟠 [P1] BUILD — `security-scan`, 2. 🟠 [P1] TEST — `backend-test`, 3. 🟠 [P1] BUILD — `deploy-frontend`, Audit Metadata, CI Error Audit Report, code:bash (docker build -f backend/Dockerfile .), code:bash (cd admin-dashboard && npm run build), code:bash (cd rider-app && yarn build:web) (+13 more)
...
Cohesion: 0.05
Nodes (42): 1. What shipped in this commit, 1a. Redis row-level cache (`backend/db_supabase.py`), 1b. Circuit breaker tightened (`_CircuitBreaker`), 2. How Redis helps (high-level diagrams), 2a. Before the cache, 2b. After the cache, 2c. End-to-end request flow with cache + circuit breaker + retry, 3. Extending Redis to more DB calls — the rules (+34 more)

### Community 535 - "Community 535"
Cohesion: 0.15
Nodes (23): admin_driver_daily_activity(), Driver daily activity: per-phase km, empty (P1+P2) vs riding (P3) time, and, Driver daily activity: per-phase km, empty (P1+P2) vs riding (P3) time, and, Any, datetime, float, str, date_cls (+15 more)
...
Cohesion: 0.08
Nodes (21): _offer_timeout_handler(), Auto-expire a driver's ride offer if they don't accept/decline.      Sleeps for, Auto-expire a driver's ride offer if they don't accept/decline.      Sleeps for, Auto-expire a driver's ride offer if they don't accept/decline.      Sleeps fo, Tests for _offer_timeout_handler — the backend-enforced offer TTL.  Also cover, Ride reassigned to a different driver → handler does nothing., Tests for routes/rides._offer_timeout_handler., Ride deleted/not found → handler does nothing. (+13 more)
...
Cohesion: 0.10
Nodes (19): 1. 🟠 [P1] TEST — `backend-test`, 2. 🟠 [P1] TEST — `driver-app-test`, 3. 🟠 [P1] TEST — `rider-app-test`, Audit Metadata, CI Error Audit Report, code:bash (pytest <test_path> -v), code:bash (pytest -v), code:bash (pytest <test_path> -v) (+11 more)

### Community 2359 - "Community 2359"
Cohesion: 0.10
Nodes (19): 1. 🟡 [P2] LINT — `backend-test`, 2. 🟠 [P1] BUILD — `backend-test`, Audit Metadata, CI Error Audit Report, code:block1 (2026-04-28T06:14:25.8191150Z Found 2 errors.), code:block2 (2026-04-28T06:14:26.3831562Z Could not pull latest version i), code:bash (ruff check . --fix && ruff format .), code:bash (npx tsc --noEmit) (+11 more)

### Community 2360 - "Community 2360"
Cohesion: 0.05
Nodes (38): Benefits of This Approach, code:typescript (// REMOVE THESE (lines 7-11)), code:typescript (// REMOVE THESE (lines 46-48)), code:typescript (// REMOVE THESE (lines 50-52)), code:tsx ({/* Pickup Autocomplete */}), code:tsx ({/* Dropoff Autocomplete */}), Fix for SearchDestinationScreen Autocomplete Implementation, FOR DROPOFF (replace lines 314-348): (+30 more)

### Community 2361 - "Community 2361"
Cohesion: 0.15
Nodes (11): styles, Index(), AuthState, Driver, storage, useAuthStore, User, mockUser (+3 more)

### Community 2362 - "Community 2362"
Cohesion: 0.24
Nodes (4): Validate GPS coordinates.      Valid ranges:     - Latitude: -90 to 90     -, Validate GPS coordinates.      Valid ranges:     - Latitude: -90 to 90     - Lon, validate_coordinates(), TestValidateCoordinates
...
Cohesion: 0.12
Nodes (16): str, _driver_row(), P1-8: Role-claim tampering guard (S3, S8) + S1 fix  S1 — Rider tries to accept, A pure rider (no driver row) gets 404 — no driver record found., A real driver accepting a ride from a different rider must succeed         (up, Role is always read from the DB row, never trusted from the JWT payload., A JWT with `role: 'admin'` for a regular DB user must not pass         `get_adm, GET /drivers/earnings must always return the authenticated driver's own     ear (+8 more)

### Community 2366 - "Community 2366"
Cohesion: 0.20
Nodes (10): Load a driver's ride only if it is in one of ``allowed_states``.      Raises 409, Load a driver's ride only if it is in one of ``allowed_states``.      Raises 4, _require_ride_in_state(), Retrying arrive after the first call should succeed, not 409., Cannot start a ride that was already completed., Pin the state-machine guard behavior., Return a context manager that patches backend.routes.drivers.db         so find, A cancelled ride cannot be completed — must raise 409, not 404. (+2 more)
...
Cohesion: 0.12
Nodes (26): bool, Path, str, apply_migration(), _apply_migration_autocommit(), get_applied_versions(), get_db_connection(), get_migration_files() (+18 more)
...
Cohesion: 0.26
Nodes (15): Any, bool, datetime, str, effective_available(), effective_online(), filter_effective_online(), intent_online() (+7 more)
...
Cohesion: 0.19
Nodes (16): CACHE_CONFIG, CACHE_KEYS, CacheEntry, CacheStorage, createStorage(), storage, DocumentRequirement, DocumentState (+8 more)
...
Cohesion: 0.20
Nodes (11): styles, RideStatusScreen(), Driver, Location, NearbyDriver, Ride, RideEstimate, RideState (+3 more)
...
Cohesion: 0.12
Nodes (13): str, compute_instant_payout_fee(), Fee charged on an instant payout. Caller subtracts to get net., Fee charged on an instant payout. Caller subtracts to get net., _bank_account(), _driver(), Tests for instant-payout (Stripe Instant Pay) in routes/drivers.py.  Covers th, Transfer succeeds, Payout fails → reversal succeeds.          Row should end i (+5 more)

### Community 2425 - "Community 2425"
Cohesion: 0.12
Nodes (11): Tests for ride API endpoints., Tests for ride API endpoints., Test ride creation endpoint., Test ride creation endpoint., Test get ride endpoint., Test get ride endpoint., Test get user rides endpoint.          Smoke test: we accept any of {200 auth-, Test get user rides endpoint.          Smoke test: we accept any of {200 auth-ok (+3 more)
...
Cohesion: 0.11
Nodes (18): bool, Request, Response, str, _apply_security_headers(), _extract_user_id(), FirebaseAppCheckMiddleware, Attach the baseline security headers to a response.      Uses dict-style assignm (+10 more)
...
Cohesion: 0.22
Nodes (21): MagicMock, Request, _fake_request(), _mock_httpx_response(), Tests for the rider-facing Google Maps proxy.  Covers the cost-control contrac, Build an httpx-like response object for unit testing., Build a minimal real Request that slowapi's isinstance check accepts., Build an httpx-like response object for unit testing. (+13 more)

### Community 2449 - "Community 2449"
Cohesion: 0.17
Nodes (8): MockCursor, int, Minimal cursor stub that mirrors the old MongoDB cursor interface.      Tests, Tests for the MockCursor class., Test cursor is initialized with correct filter.          The field is ``.filte, Test cursor to_list returns list of documents., Test cursor method chaining (sort, skip, limit)., TestMockCursor
...
Cohesion: 0.18
Nodes (5): MockWebSocket, onEvent, originalEnv, { rerender }, { result }
...
Cohesion: 0.20
Nodes (8): AgentTask, Any, str, Store frontend-specific knowledge., Implement UI feature., Create a reusable component., Manage application state., Integrate API endpoints.
...
Cohesion: 0.12
Nodes (15): 1. 🟠 [P1] TEST — `backend-test`, 2. 🟠 [P1] TEST — `rider-app-test`, Audit Metadata, CI Error Audit Report, code:bash (pytest <test_path> -v), code:bash (pytest -v), code:bash (pytest <test_path> -v), code:bash (pytest -v) (+7 more)
...
Cohesion: 0.12
Nodes (15): 1. 🟠 [P1] TEST — `rider-app-test`, 2. 🟠 [P1] TEST — `backend-test`, Audit Metadata, CI Error Audit Report, code:bash (pytest <test_path> -v), code:bash (pytest -v), code:bash (pytest <test_path> -v), code:bash (pytest -v) (+7 more)
...
Cohesion: 0.12
Nodes (20): MagicMock, mock_db_collections(), mock_firebase_admin(), mock_rate_limiter(), mock_sms_service(), mock_supabase_client(), patch_external_dependencies(), Pytest configuration and fixtures for Spinr backend tests. This file provides s (+12 more)
...
Cohesion: 0.12
Nodes (15): code:bash (cd C:/Users/TabUsrDskOff111/Documents/Spinrvm/spinrvm), Design Documents (Read First), 📖 Everything You Need, Fresh Session: P0 Sprint Phase 3 Implementation, 🎬 Go!, ❓ If You Get Stuck, Phase 1 (Complete ✅), Phase 2 (Pending) (+7 more)
...
Cohesion: 0.18
Nodes (11): 1. Unit Tests with Pytest (Backend), 2. E2E Tests with Detox (Frontend), code:bash (cd spinr/backend), code:bash (cd spinr/frontend), Configuration Files, Pytest Configuration, Running E2E Tests, Running Tests (+3 more)
...
Cohesion: 0.22
Nodes (7): AgentTask, Any, str, Implement a backend feature., Develop API endpoints., Optimize database queries., Store backend-specific knowledge.
...
Cohesion: 0.13
Nodes (15): TestClient, admin_override(), auth_headers(), Return authorization headers with mock JWT token., Return authorization headers with mock JWT token., Reset in-process rate-limiter storage before each test.      The real SlowAPI Li, Reset MemoryStorage on a SlowAPI Limiter instance (if present)., Reset in-process rate-limiter storage before each test.      The real SlowAPI (+7 more)
...
Cohesion: 0.13
Nodes (14): Admin Dashboard — CI/CD secrets (GitHub Actions → Vercel), Admin Dashboard (Next.js — `admin-dashboard/`), Backend — CI-only secrets (GitHub Actions), Backend (FastAPI — `backend/`), Backend — Secrets stored in `app_settings` (Supabase table, not env vars), code:dotenv (SUPABASE_URL=https://<your-project-ref>.supabase.co), code:dotenv (EXPO_PUBLIC_GOOGLE_MAPS_API_KEY=<your_maps_key>), code:dotenv (EXPO_PUBLIC_GOOGLE_MAPS_API_KEY=<your_maps_key>) (+6 more)

### Community 2504 - "Community 2504"
Cohesion: 0.07
Nodes (28): code:bash (npm install react-native-maps react-native-google-places-aut), code:json ({), code:tsx (import React from 'react';), code:tsx (import { GooglePlacesAutocomplete } from 'react-native-googl), code:bash (npm install react-native-maps-directions), code:tsx (import MapViewDirections from 'react-native-maps-directions'), Google Maps & Places API Integration Instructions, Prerequisites (+20 more)
...
Cohesion: 0.07
Nodes (28): Architecture, Backend, code:bash (cd backend), code:bash (# From repo root), code:bash (python3 -m unittest backend/tests/verify_db.py), code:bash (cd frontend), code:bash (npx expo start), Deployment (+20 more)
...
Cohesion: 0.01
Nodes (334): DocumentRequirementCreateRequest, DocumentRequirementUpdateRequest, AreaFeeUpdateRequest, AreaTaxRequest, ServiceAreaCreateRequest, ServiceAreaUpdateRequest, SurgePricingRequest, StaffUpdateRequest (+326 more)

### Community 2514 - "Community 2514"
Cohesion: 0.20
Nodes (11): str, ChatRequest, EscalateRequest, support.py — AI-powered support chat endpoint using Gemini 1.5 Flash.  POST /s, Send a message to the Gemini AI support bot and receive a reply.      The user m, Send a message to the Gemini AI support bot and receive a reply.      The user m, Send a message to the Gemini AI support bot and receive a reply.      The user, Escalate a support chat to a human by opening a Zoho Desk ticket.      Returns (+3 more)
...
Cohesion: 0.27
Nodes (5): AgentTask, Any, str, Record an architecture decision., Record a code pattern.
...
Cohesion: 0.20
Nodes (9): Backend API Endpoints Used by Driver App, code:block1 (spinr/driver-app/), Driver App - Detailed Analysis Report, Driver App Structure, For Production:, Immediate Fixes Needed:, Overview, Recommendations (+1 more)

### Community 2529 - "Community 2529"
Cohesion: 0.11
Nodes (36): get_dashboard_health(), Concise operational health for uptime checkers and ops dashboards.      Returns, Concise operational health for uptime checkers and ops dashboards.      Returns, Concise operational health for uptime checkers and ops dashboards.      Returns, Concise operational health for uptime checkers and ops dashboards.      Return, float, str, bool (+28 more)

### Community 2530 - "Community 2530"
Cohesion: 0.18
Nodes (11): FastAPI, _app_with_auth_router(), B-P1-8 — pin the 429 rate-limit response shape across all auth gates.  Two dis, Pins the OTP lockout 429 contract. _check_otp_lockout raises     HTTPException(, Build a stripped FastAPI app that mounts only the auth router and     wires the, Pins the response shape for slowapi-tripped 429s. /auth/logout is     rate-limi, The body is the fallback for clients running through proxies         that strip, test_otp_lockout_emits_retry_after_and_ratelimit_headers() (+3 more)
...
Cohesion: 0.24
Nodes (13): bool, int, _call_set_available(), _passthrough_run_sync(), Unit tests for the is_available ⇒ is_online invariant in repositories/driver_re, Build a fluent supabase mock. select(...) returns the row's online     state; u, available=True on an offline driver clamps is_available to False., available=True on an online driver stays available. (+5 more)

### Community 2533 - "Community 2533"
Cohesion: 0.18
Nodes (18): Any, bool, int, str, _apply_filters(), count_by_status(), fetch_window(), list_mirror() (+10 more)
...
Cohesion: 0.26
Nodes (6): AgentTask, Any, str, Create test cases for given code., Run integration tests., Run regression tests.
...
Cohesion: 0.41
Nodes (12): go_online(), log(), login(), main(), poll_driver_me(), int, str, Reproduce the driver "cannot go online" issue without the mobile app.  Simulat (+4 more)
...
Cohesion: 0.08
Nodes (24): build, builder, dockerfilePath, deploy, healthcheckPath, healthcheckTimeout, numReplicas, restartPolicyMaxRetries (+16 more)
...
Cohesion: 0.24
Nodes (10): bool, datetime, Decimal, str, evaluate_policy_for_ride(), _from_dict(), PolicyResult, Policy evaluation for corporate ride bookings (v1 stub).  Public API:   evalu (+2 more)

### Community 2614 - "Community 2614"
Cohesion: 0.16
Nodes (8): _crumb(), _FakeClient, _FakeNoMatchClient, _FakeNoMatchResp, _FakeResp, test_downsample_preserves_latest_point(), test_osrm_no_match_is_likely_spoofed_without_google_fallback(), test_validate_trip_route_prefers_osrm_match()
...
Cohesion: 0.12
Nodes (41): derive_driver_onboarding_status(), _has_profile(), _has_vehicle(), _parse_date(), Any, bool, datetime, str (+33 more)

### Community 2617 - "Community 2617"
Cohesion: 0.09
Nodes (32): Any, float, int, str, RoadMatch, _crumb(), Tests for backend/utils/route_distance.py — Roads-API distance recompute.  The, Happy path: ~7 km trip, API returns interpolated snapped points,         we sum (+24 more)

### Community 2618 - "Community 2618"
Cohesion: 0.23
Nodes (8): RootLayout(), metadata, AnalyticsWrapper(), ThemeProvider(), Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger()
...
Cohesion: 0.20
Nodes (9): 1. Missing Environment Variables, 2. Firebase Not Configured, 3. Twilio Not Configured, 4. Admin Dashboard Has No Authentication, 5. CORS Allows All Origins, code:block1 (Backend (.env):), code:typescript (firebase: {), code:typescript (twilio: {) (+1 more)

### Community 2621 - "Community 2621"
Cohesion: 0.33
Nodes (11): MagicMock, str, _fake_intent(), _make_ride(), Unit tests for payment_retry double-charge guard.  Verifies that: 1. A Stripe, When Stripe reports the PI as 'requires_payment_method', the loop must:       -, When stripe.PaymentIntent.retrieve raises a StripeError, the loop must:       -, When Stripe reports the PI as 'succeeded', the loop must:       - Update the DB (+3 more)
...
Cohesion: 0.09
Nodes (22): API Configuration, Autocomplete Implementation, Dependencies Installed, Google Maps & Places API Integration - COMPLETE, 📋 Implementation Summary, ✅ Integration Status: FULLY IMPLEMENTED, 🎯 Key Improvements Made, Map Implementation (+14 more)
...
Cohesion: 0.22
Nodes (8): API_URL, getBackendUrl(), styles, client, getAuthHeader(), getStoredToken(), LoginScreen(), firebaseConfig

### Community 2649 - "Community 2649"
Cohesion: 0.25
Nodes (17): _atan2_pos(), _clamp(), main(), _over(), Render the Spinr spiral mark centered in a size×size RGBA buffer.      Uses th, Emit the Spinr spiral mark as a scalable SVG (same geometry as the PNGs)., Source-over compositing. dst/src premultiplied-free, alpha in [0,1]., render_mark() (+9 more)

### Community 2650 - "Community 2650"
Cohesion: 0.22
Nodes (8): CODE REVIEW REPORT: Uncommitted Changes - spinrApp, Executive Summary, FILES REVIEWED, Modified Files, New Files (Created), RECOMMENDATIONS, 📊 SUMMARY TABLE, TECHNICAL STACK
...
Cohesion: 0.38
Nodes (5): Regression test for backend/features.py :: admin_reset_surge_to_auto.  With th, Reset-to-auto must set surge_source=auto, surge_active and surge_enabled., Unknown area still 404s and writes nothing., test_reset_to_auto_404_when_area_missing(), test_reset_to_auto_enables_surge_gate()
...
Cohesion: 0.17
Nodes (10): 18. Architecture Decision Records (ADRs), 3. Application Surface Map, 5. Rider App — Full File Mapping, 8. Shared Package — Full File Mapping, App Screens (Expo Router — file = route), Architecture Reference, Integration Guide & Alignment Document, code:block3 (spinr/), Rider Stores (+2 more)
...
Cohesion: 0.22
Nodes (9): Admin Dashboard, Backend (Python/FastAPI), code:bash (cd backend), code:bash (cd rider-app   # or driver-app), code:bash (cd admin-dashboard), code:bash (cd backend), Commands, Database Migrations (+1 more)
...
Cohesion: 0.10
Nodes (20): 1. Backend Deployment (Railway - Recommended), 2. Frontend Deployment (Vercel), 3. Driver App Deployment (Vercel), 4. Admin Dashboard Deployment (Vercel), Alternative: Backend Deployment (Render), CI/CD for Railway, code:bash (railway variables set \), code:bash (railway up --service backend) (+12 more)
...
Cohesion: 0.33
Nodes (11): _make_driver_filter(), Unit tests for L-P0-3: WAV (wheelchair-accessible vehicle) dispatch support., test_create_ride_request_accepts_requires_wav_true(), test_create_ride_request_requires_wav_defaults_false(), test_find_candidate_drivers_no_is_wav_for_standard_ride(), test_find_candidate_drivers_passes_is_wav_filter(), test_find_candidate_drivers_returns_empty_when_no_wav_driver(), test_non_wav_filter_fields_unchanged_for_wav_ride() (+3 more)

### Community 2715 - "Community 2715"
Cohesion: 0.02
Nodes (95): Request, str, _actual_duration_minutes(), add_stop_mid_trip(), cancel_scheduled_ride(), create_demo_drivers(), _decode_polyline(), _dispatch_retry() (+87 more)

### Community 2716 - "Community 2716"
Cohesion: 0.31
Nodes (8): main(), CI Error Audit — main orchestrator (local dev / manual run entry point).  Usag, _run(), run_full_audit(), int, Path, str, Smoke-test publish/subscribe when Redis is not configured (in-process mode).
...
Cohesion: 0.15
Nodes (12): ratio < 0.5 → 1.0× (no surge)., demand=15, supply=4 → ratio=3.75 → SURGE_CAP., ratio == 0.5 falls into [0.5, 0.8) → 1.25×., ratio == 2.0 falls into [2.0, 3.0) → 2.0×., ratio == 3.0 hits the hard cap → 2.5× (SURGE_CAP)., Only rides in active statuses contribute to demand count., test_calculate_surge_high_demand_returns_cap(), test_count_demand_counts_active_statuses_only() (+4 more)
...
Cohesion: 0.17
Nodes (11): Unit tests for backend/utils/surge_engine.py  Coverage: - ratio_to_multiplier, get_service_area_polygon returns None → supply is 0., DB exception in _count_supply_in_area → returns 0 (does not propagate)., Drivers not in present_driver_ids set are excluded from supply count., demand=0, supply=5 → ratio=0 → multiplier=1.0., DB exception in _count_demand_in_area → returns 0 (does not propagate)., test_calculate_surge_no_demand_returns_normal(), test_count_demand_db_failure_returns_zero() (+3 more)

### Community 2753 - "Community 2753"
Cohesion: 0.17
Nodes (10): Regression tests for the scheduled-ride dispatch fixes (CR-1, CR-2).  CR-1: cr, check_scheduled_rides must read rows in status='scheduled'., check_scheduled_rides must read rows in status='scheduled'., If the rider has a live trip, the scheduled→searching claim collides         wi, check_scheduled_rides must read rows in status='scheduled'., If another replica already flipped the row, update_one returns None         and, If another replica already flipped the row, update_one returns None         and, If another replica already flipped the row, update_one returns None         and (+2 more)

### Community 2754 - "Community 2754"
Cohesion: 0.35
Nodes (12): datetime, str, _escalate(), _escalated_key(), _ok_key(), Safety check-in loop (Feature D — P3).  For rides that have been ``in_progress, Periodic check-in loop — runs on every replica; Redis keys provide idempotency., Periodic check-in loop — runs on every replica; Redis keys provide idempotency. (+4 more)
...
Cohesion: 0.49
Nodes (8): ClassifiedError, classify(), _classify_log_chunk(), _job_to_surface(), main(), Classify CI failure signals from a GitHub Actions run into structured errors., Any, str

### Community 2757 - "Community 2757"
Cohesion: 0.44
Nodes (8): _build_cr_list(), FixRecommendation, FixStep, main(), Generate fix recommendations for classified CI errors.  Safe fixes (CI config, _recommend(), Any, str

### Community 2758 - "Community 2758"
Cohesion: 0.49
Nodes (8): assess(), _assess_error(), _get_changed_files_from_git(), main(), _map_files_to_surfaces(), Assess the impact / blast radius of classified CI errors.  Input:  classified_, Any, str
...
Cohesion: 0.12
Nodes (16): Baseline: Sprint 9 Audit (2026-04-09), How to Add a New Finding, Open — Dependencies, Open — MEDIUM, Open — Pre-Production Gate (Phase 5 SEC-1), Phase 5 Checklist, Resolved, Spinr — Open Items Tracker (+8 more)
...
Cohesion: 0.20
Nodes (8): AgentTask, Any, str, Store security-specific knowledge., Perform security review., Scan for vulnerabilities., Review authentication mechanisms., Check compliance with security standards.
...
Cohesion: 0.12
Nodes (16): 1. Backend (Fast API), 3. Rider App (Expo/React Native), 4. Frontend Web (Expo Router), 6. Shared Configuration, API Endpoints (49 endpoints):, Component Analysis, Configuration:, Database Schema: (+8 more)
...
Cohesion: 0.40
Nodes (4): Tests for the ride state-machine guard in routes/drivers.py.  These pin the C-, Sanity check: no source-state allowlist should include terminals., Sanity check: no source-state allowlist should include terminals., test_state_constants_are_disjoint_from_terminal()

### Community 2790 - "Community 2790"
Cohesion: 0.18
Nodes (14): Tests for utils/retention_purge.py — B-P1-6 daily PII purge loop.  The Postgre, CLAUDE.md: never silently swallow DB errors. The wrapper logs     via logger.ex, Scheduling math: should always return a positive sleep duration,     never slee, Two replicas calling redis_set_nx with the same key — the first     wins, the s, Happy path: rpc returns a JSONB dict, the function returns it     verbatim and, Dev/test without SUPABASE_URL — should not raise, returns None., If the rpc response is shaped differently (PostgREST upgrade,     schema drift), test_leader_lock_blocks_second_acquirer() (+6 more)

### Community 2791 - "Community 2791"
Cohesion: 0.25
Nodes (8): A. Missing Database Schema Setup, B. Missing Legal Content, C. Legal Pages Not Linked Properly, code:typescript (script.src = `https://maps.googleapis.com/maps/api/js?key=${), code:typescript (fetch(`${SpinrConfig.api.baseUrl}/settings/legal`)), D. Missing Google Maps API Key, E. Missing API Base URL Configuration, Missing Features & Broken Links
...
Cohesion: 0.25
Nodes (7): CI/CD Pipeline, code:bash (# Supabase), Pipeline Stages, Required Secrets, Spinr Testing Strategy & Technical Enhancements, Summary, Table of Contents
...
Cohesion: 0.29
Nodes (7): 2. Driver App (Expo/React Native), code:block2 (idle → ride_offered → navigating_to_pickup →), Issues Identified:, Key Features:, Key Screens:, State Management:, Technology Stack:

### Community 2809 - "Community 2809"
Cohesion: 0.29
Nodes (7): Admin Dashboard:, Backend:, code:block4 (fastapi>=0.110.0), code:block5 (expo~=54.0.0), code:block6 (next@16.1.6), Dependencies Summary, Mobile Apps:

### Community 2810 - "Community 2810"
Cohesion: 0.64
Nodes (8): run_migrations.sh script, run_migrations.sh script, apply_file(), error(), info(), is_applied(), MIGRATION_FILES, warn()

### Community 2811 - "Community 2811"
Cohesion: 0.25
Nodes (8): Architecture, Backend Changes, code:block1 (├── CookieManager (new utility)), code:typescript (// Remove: localStorage.setItem('auth_token', token)), code:typescript (const adminClient = axios.create({), code:block4 (Client sends: GET /some-protected-endpoint), Frontend Changes, Token Rotation Flow (POST /auth/refresh)
...
Cohesion: 0.29
Nodes (7): 10. Safety incident submission (see #4), 11. Subscription verify-session + cancel hooks vs Stripe, 12. Driver-side listing of safety/emergency history, 7. `GET /drivers/tax-documents` (listing), 8. Public service areas endpoint (see #1), 9. Public FAQ endpoint (see #2), P1 — Missing driver-facing endpoints (call site exists or is needed, route doesn't)
...
Cohesion: 0.13
Nodes (14): Contact, In-Scope Surfaces, Out of Scope, Reporting a Vulnerability, Rewards, Safe Harbor, Security Policy, Contact (+6 more)
...
Cohesion: 0.13
Nodes (14): Completed / Verified Implemented, Critical Issues (Must Fix), High Priority, Low Priority, Medium Priority, Open Branches (Unmerged Work), Spinr TODO List, Completed / Verified Implemented (+6 more)
...
Cohesion: 0.02
Nodes (99): init_firebase(), Initialize Firebase Admin SDK, Initialize Firebase Admin SDK, create_refresh_token(), generate_pickup_otp(), get_current_user(), hash_token(), Return True if the access-token's token_version is stale.      Tokens minted b (+91 more)

### Community 2837 - "Community 2837"
Cohesion: 0.29
Nodes (5): bool, str, FakeReminderDB, test_duplicate_daily_claim_suppresses_duplicate_pushes(), test_sends_vehicle_details_and_document_reminders_at_8am_local()

### Community 2838 - "Community 2838"
Cohesion: 0.29
Nodes (7): 1. `GET /admin/service-areas` — hit in `become-driver` + `profile-setup`, 2. `GET /faqs` — hit in driver FAQ screen, 3. `GET /legal/content` — hit in Legal screen, 4. `POST /safety/report` — hit in Report Safety screen, 5. Payout screen: three wrong paths, 6. `POST /rides/{rideId}/tip` — called from `driverStore.submitTip`, P0 — Broken calls (HTTP 4xx / 5xx in production)
...
Cohesion: 0.29
Nodes (7): 4. Fare-Collection State Mismatch (PAYMENT-001), code:python (def test_duplicate_payment_returns_cached_result():), code:typescript (test('retry with same idempotency key does not double-charge), Current State, Files to Modify, Rollout Plan, Testing Strategy

### Community 2848 - "Community 2848"
Cohesion: 0.29
Nodes (7): code:typescript (function useAuth() {), code:typescript (function useAuth() {), code:typescript (// Delete these:), code:typescript (// Use Redux/Zustand store instead), File: `rider-app/hooks/useAuth.ts`, File: `rider-app/store/rideStore.ts`, Step 7: Remove localStorage Token Sync
...
Cohesion: 0.15
Nodes (12): ✅ Completed Items, Current Status Analysis, Google Maps & Places API Integration Gap Analysis, ⚠️ Notes, Summary, 📋 Verification Checklist, ✅ Completed Items, Current Status Analysis (+4 more)

### Community 2858 - "Community 2858"
Cohesion: 0.64
Nodes (7): setup-claude.sh script, setup-claude.sh script, fail(), ok(), skip(), step(), warn()

### Community 2859 - "Community 2859"
Cohesion: 0.29
Nodes (6): 3. Enhanced Error Handling, code:json ({), Error Code Ranges, Error Response Format, Features, Usage
...
Cohesion: 0.20
Nodes (5): Turning surge_enabled off must zero any parked surge on the area., Switching off a parked >2.5x surge must not require a justification.          Th, Turning surge_enabled off must zero any parked surge on the area., Switching off a parked >2.5x surge must not require a justification., TestServiceAreaValidation
...
Cohesion: 0.20
Nodes (7): bool, str, _is_valid_review_otp(), Parse REVIEW_LOGIN_ACCOUNTS into {phone: fixed_otp}.          Only entries whose, Parse REVIEW_LOGIN_ACCOUNTS into {phone: fixed_otp}.          Only entries who, Surface a misconfigured REVIEW_LOGIN_ACCOUNTS at startup.          We do not rai, Surface a misconfigured REVIEW_LOGIN_ACCOUNTS at startup.          We do not r
...
Cohesion: 0.33
Nodes (4): Validate email address format.      Args:         email: Email address string, Validate email address format.      Args:         email: Email address string to, validate_email(), TestValidateEmail

### Community 2931 - "Community 2931"
Cohesion: 0.20
Nodes (6): A-P3-8: Security tests for admin auth and RBAC scenarios.  Covers six critical, A deactivated staff member cannot log in even with correct password., A deactivated staff member cannot log in even with correct password., staff.is_active=False → 403 even when password matches., staff.is_active=False → 403 even when password matches., TestDeactivatedStaffRejected
...
Cohesion: 0.26
Nodes (10): buildCarScreen(), CarRow, CarScreenModel, dropoff(), pickup(), riderName(), blank, model (+2 more)
...
Cohesion: 0.40
Nodes (5): 3. First-Rating Crash (P1-B-P0-1), code:python (# backend/routes/rides.py, rate_driver function), Current State, Test Coverage, Verification Checklist

### Community 3159 - "Community 3159"
Cohesion: 0.40
Nodes (5): 5. GPS OOM (A-P0-3), Backend Impact, code:typescript (// driver-app/hooks/useDriverDashboard.ts), Current State, Implementation Detail

### Community 3160 - "Community 3160"
Cohesion: 0.40
Nodes (5): 6. SOS Silent Failure (SAFETY-007), code:python (@router.post("/rides/{ride_id}/sos")), Current State, Implementation Detail, Test Coverage

### Community 3161 - "Community 3161"
Cohesion: 0.40
Nodes (5): code:bash (git checkout main), Implementation Sequence, Phase 1: Merge Complete Fixes (Tomorrow), Phase 2: Payment Idempotency (1 day), Phase 3: HttpOnly Token Storage (3-4 days)

### Community 3162 - "Community 3162"
Cohesion: 0.40
Nodes (5): AFTER (New — Secure), Architecture: Old vs New, BEFORE (Current — Vulnerable), code:block1 (┌──────────────────────┐), code:block2 (┌──────────────────────┐)

### Community 3163 - "Community 3163"
Cohesion: 0.40
Nodes (5): Backend Unit Test, code:python (import pytest), code:typescript (import { apiClient } from '@spinr/utils/apiClient'), Frontend Integration Test, Step 9: Testing

### Community 3164 - "Community 3164"
Cohesion: 0.40
Nodes (5): Browser (Admin Dashboard), code:bash (# Login to admin.spinrvm-staging.ca), code:bash (# Deploy to EAS preview), Mobile (Rider App), Step 10: Staging Verification Checklist

### Community 3165 - "Community 3165"
Cohesion: 0.40
Nodes (5): code:typescript (const adminClient = axios.create({), File: `admin-dashboard/lib/api.ts`, File: `driver-app/hooks/useAuth.ts`, File: `driver-app/utils/apiClient.ts`, Step 8: Same for Driver & Admin

### Community 3166 - "Community 3166"
Cohesion: 0.40
Nodes (5): code:python (# BEFORE (OLD)), code:python (# BEFORE (OLD)), code:python (# BEFORE (OLD)), File: `backend/routes/auth.py`, Step 3: Update Auth Endpoints
...
Cohesion: 0.71
Nodes (5): test_pre_commit.sh script, test_pre_commit.sh script, _fail(), _pass(), _run_gate()
...
Cohesion: 0.33
Nodes (6): Batch size rule, Context / token discipline, PR review handling (Codex auto-review), Request timeouts, Task decomposition (mandatory), Working Style

### Community 3198 - "Community 3198"
Cohesion: 0.50
Nodes (4): AbstractEventLoop, event_loop(), Create an instance of the default event loop for each test session., Create an instance of the default event loop for each test session.

### Community 3199 - "Community 3199"
Cohesion: 0.50
Nodes (4): AsyncClient, async_http_client(), Create an async HTTP client for testing., Create an async HTTP client for testing.
...
Cohesion: 0.50
Nodes (4): 2. Admin TTL Reduction, code:python (# backend/core/config.py), Current State, Verification

### Community 3221 - "Community 3221"
Cohesion: 0.50
Nodes (4): Backend (9 files), Files Changed Summary, Frontend (6 files across all apps), Migrations

### Community 3222 - "Community 3222"
Cohesion: 0.50
Nodes (4): ✅ COMPLETE (3 of 6), 🟡 PARTIAL (1 of 6), Summary: What's Done vs. Remaining, ⬜ TODO (2 of 6)

### Community 3223 - "Community 3223"
Cohesion: 0.50
Nodes (4): code:bash (git revert <commit>), code:python (# backend/core/config.py), If Cookies Fail in Staging, Rollback Procedure
...
Cohesion: 0.50
Nodes (4): MonkeyPatch, mock_redis(), Provide a fresh, isolated in-process Redis store for each test.      Replaces ba, Provide a fresh, isolated in-process Redis store for each test.      Replaces

### Community 3231 - "Community 3231"
Cohesion: 0.29
Nodes (6): devDependencies, commitlint, @commitlint/config-conventional, devDependencies, commitlint, @commitlint/config-conventional
...
Cohesion: 0.33
Nodes (6): 11. Inconsistent Error Responses, 12. Missing Rate Limiting on Promo Validation, 13. Hardcoded Query Limits, 14. No Logging for Dispute Resolution, 15. Missing Index on Notification Queries, 🟡 MEDIUM PRIORITY GAPS

### Community 3239 - "Community 3239"
Cohesion: 0.33
Nodes (5): 17. No Return Value Check on update_many(), 18. Missing Type Hints in Some Functions, 19. Inconsistent ISO Date Format, code:python (await db.notifications.update_many(...)), 🟢 LOW PRIORITY / CODE QUALITY
...
Cohesion: 0.32
Nodes (6): Request, health_check(), Main router aggregator Import all route modules and combine them here, Liveness + readiness probe used by Railway health checks and the     post-deplo, Liveness + readiness probe used by Railway health checks and the     post-deploy, root()
...
Cohesion: 0.25
Nodes (8): bool, int, admin_get_quest_participants(), admin_list_quests(), List all quests with participation stats (admin only)., List all quests with participation stats (admin only)., Get participants of a quest with progress details (admin only)., Get participants of a quest with progress details (admin only).
...
Cohesion: 0.33
Nodes (6): Adding New Error Types, Adding New Tests, code:bash (# Backend), Configuring Analytics, Quick Start for Development, Usage Guide
...
Cohesion: 0.33
Nodes (6): 10. Scheduled Rides Missing Reminder Logic, 6. No Dispute Evidence/Attachments Support, 7. Missing Dispute Deadline/Expiry, 8. Push Notification Delivery Not Implemented, 9. Notification Preferences Not Enforced, 🟠 HIGH PRIORITY GAPS
...
Cohesion: 0.29
Nodes (5): WebSocket fan-out over Redis pub/sub (audit P0-B3).  The in-process ``Connecti, Pick the effective Redis URL for WS pub/sub.      Prefer ``WS_REDIS_URL`` when s, Pick the effective Redis URL for WS pub/sub.      Prefer ``WS_REDIS_URL`` when s, Pick the effective Redis URL for WS pub/sub.      Prefer ``WS_REDIS_URL`` when, resolve_ws_redis_url()

### Community 3259 - "Community 3259"
Cohesion: 0.67
Nodes (3): code:python (from fastapi.middleware.cors import CORSMiddleware), File: `backend/core/middleware.py`, Step 5: Middleware — CORS + Cookie Support
...
Cohesion: 0.29
Nodes (6): get_available_quests(), Get quests available to the current driver., Get quests available to the current driver., Pins get_available_quests: active + in-window quests returned with progress., Pins get_available_quests: active + in-window quests returned with progress., TestGetAvailableQuests

### Community 3380 - "Community 3380"
Cohesion: 0.38
Nodes (3): styles, { width }, RideCompletedScreen()
...
Cohesion: 0.40
Nodes (5): 4. Hardcoded Payment Method, 5. Incomplete Error Handling in API Client, 6. Missing Null Checks, code:typescript (const PAYMENT_METHODS = [), ⚠️ Medium Priority Issues (Not Yet Fixed)

### Community 3385 - "Community 3385"
Cohesion: 0.40
Nodes (5): Critical (Should Fix), High Priority, Low Priority, Medium Priority, Summary of Issues
...
Cohesion: 0.40
Nodes (5): 16. Driver destination zone (commute home), 17. Driver leaderboard, 18. Driver document delete, 19. `is_available` toggle, P3 — Driver-app features implemented but not fully wired
...
Cohesion: 0.40
Nodes (5): 20. `POST /drivers/location-batch` body shape, 21. `POST /drivers/rides/{id}/cancel` uses query-string for reason, 22. `POST /rides/{id}/emergency` body, 23. Notifications register-token body, P4 — Payload / schema mismatches (runtime-safe but brittle)
...
Cohesion: 0.05
Nodes (104): AuthResponse, bool, int, Response, str, str, bool, datetime (+96 more)

### Community 3392 - "Community 3392"
Cohesion: 0.40
Nodes (5): 24. Driver-app `profile.tsx` updates user profile via `POST /users/profile`, 25. Driver-app `POST /users/profile` can set `role`, 26. Document upload: dual paths, 27. `driverStore.rateRider` posts `{rating, comment}` — backend stores as `rider_comment`, P5 — Security / correctness concerns
...
Cohesion: 0.40
Nodes (5): 1. Driver App Ride Flow, 2. Rider App Ride Flow, 3. Admin Dashboard Missing Features, code:block7 (idle → ride_offered → navigating_to_pickup →), Flow Issues
...
Cohesion: 0.29
Nodes (4): Unit tests for database layer (db.py and db_supabase.py). Tests cover CRUD oper, Tests for the main DB wrapper., Test all expected collections exist on db object., TestDBWrapper
...
Cohesion: 0.31
Nodes (7): BrandSplash(), LOGO, LOGO_HEIGHT, LOGO_WIDTH, Props, styles, TAGLINE_SIZE
...
Cohesion: 0.33
Nodes (6): _mask_credentials(), Return a copy of the settings dict with credential values masked., Return a copy of the settings dict with credential values masked., Return a copy of the settings dict with credential values masked., Any, str
...
Cohesion: 0.47
Nodes (3): styles, { width }, DriverArrivedScreen()

### Community 3417 - "Community 3417"
Cohesion: 0.67
Nodes (4): smoke-test.sh script, smoke-test.sh script, fail(), pass()
...
Cohesion: 0.40
Nodes (3): styles, RootLayout(), styles
...
Cohesion: 0.27
Nodes (4): Hash ADMIN_PASSWORD with bcrypt at startup (A-P3-1).          The plaintext env, Refuse to start in production with weak placeholder values, short         secret, Hash ADMIN_PASSWORD with bcrypt at startup (A-P3-1).          The plaintext en, Refuse to start in production with weak placeholder values, short         secre

### Community 3436 - "Community 3436"
Cohesion: 0.33
Nodes (4): Tests for database utility functions., Test data serialization for API responses., Test extracting single row from response., TestUtilityFunctions
...
Cohesion: 0.50
Nodes (4): Architecture, code:block5 (Rider App ──┐), Key Backend Files, System Topology

### Community 3492 - "Community 3492"
Cohesion: 0.50
Nodes (4): 10. Duplicate rideStore Implementations, 11. No Offline Support, 12. No Request Retries, 🔧 Architecture & Design Issues

### Community 3493 - "Community 3493"
Cohesion: 0.50
Nodes (4): 7. Console Logs in Production, 8. Missing Loading States, 9. Inconsistent Error Display, 📝 Low Priority Issues

### Community 3494 - "Community 3494"
Cohesion: 0.50
Nodes (4): 1. Backend URL Configuration, 2. Duplicate Config Files, code:typescript (return 'https://spinr-backend.onrender.com';  // Hardcoded f), Configuration Issues
...
Cohesion: 0.50
Nodes (4): 1. Bug: clearRide() Now Clears Stops Array ✅, 2. Duplicate Screen Registration ✅, 3. Unused Code in search-destination.tsx ✅, ✅ Recently Fixed Issues
...
Cohesion: 0.50
Nodes (4): Driver → Server, Missing WS-level features on driver side, Server → Driver, WebSocket audit
...
Cohesion: 0.40
Nodes (5): admin_get_driver_notes(), Get all notes for a driver, newest first., Get all notes for a driver, newest first., Get all notes for a driver, newest first., Get all notes for a driver, newest first.

### Community 3504 - "Community 3504"
Cohesion: 0.67
Nodes (3): code:python (try:), code:block7 (┌─► cancelled (rider/driver/system, pre-trip only)), Critical Conventions
...
Cohesion: 0.22
Nodes (6): Tests for ride creation functionality., Sample ride creation request data., Tests for ride creation functionality., Test successful ride creation., Test ride creation with promo code., TestRideCreation

### Community 3515 - "Community 3515"
Cohesion: 0.22
Nodes (6): Tests for ride history functionality., Test getting ride history for a user., Tests for ride history functionality., Test getting ride history for a driver., Test getting a specific ride by ID., TestRideHistory
...
Cohesion: 0.50
Nodes (3): Flip a ride from ``searching`` to ``driver_assigned``.          ``now`` is passe, Flip a ride from ``searching`` to ``driver_assigned``.          ``now`` is passe, Flip a ride from ``searching`` to ``driver_assigned``.          ``now`` is pas

### Community 3518 - "Community 3518"
Cohesion: 0.50
Nodes (3): Helper for ``round_robin``: find the driver_id of the most         recently assi, Helper for ``round_robin``: find the driver_id of the most         recently assi, Helper for ``round_robin``: find the driver_id of the most         recently ass
...
Cohesion: 0.67
Nodes (3): code:python (# ──── Cookie Settings ────), File: `backend/core/config.py`, Step 2: Config Updates

### Community 3525 - "Community 3525"
Cohesion: 0.29
Nodes (5): Tests for ride-driver matching functionality., Test finding nearby drivers for a ride request., Tests for ride-driver matching functionality., Test atomically claiming a driver for a ride., TestRideMatching

### Community 3526 - "Community 3526"
Cohesion: 0.29
Nodes (5): Tests for ride rating functionality., Test rating a driver after ride completion., Tests for ride rating functionality., Test rating a rider after ride completion., TestRideRatings

### Community 3527 - "Community 3527"
Cohesion: 0.29
Nodes (5): Tests for scheduled ride functionality., Test creating a scheduled ride., Tests for scheduled ride functionality., Test cancelling a scheduled ride., TestScheduledRides
...
### Community 3529 - "Community 3529"
Cohesion: 0.67
Nodes (3): Reset the db_supabase circuit breaker to closed state before each test.      The, Reset the db_supabase circuit breaker to closed state before each test.      T, reset_db_circuit_breaker()

## Knowledge Gaps
- **10834 isolated node(s):** `@commitlint/config-conventional`, `commitlint`, `$schema`, `builder`, `dockerfilePath` (+10829 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1990 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `SpinrException` connect `Community 56` to `Community 5`, `Community 6`, `Community 7`, `Community 392`, `Community 138`, `Community 399`, `Community 148`, `Community 279`, `Community 153`, `Community 2715`, `Community 28`, `Community 157`, `Community 425`, `Community 53`, `Community 57`, `Community 2366`, `Community 3391`, `Community 2755`, `Community 83`, `Community 90`, `Community 95`, `Community 98`, `Community 2789`, `Community 2793`, `Community 106`, `Community 235`, `Community 366`, `Community 381`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `RideOTPRequest` connect `Community 392` to `Community 56`, `Community 5`, `Community 3525`, `Community 3526`, `Community 3527`, `Community 3516`, `Community 3528`, `Community 3391`, `Community 3514`, `Community 2513`, `Community 376`, `Community 2425`, `Community 90`, `Community 3515`, `Community 2652`, `Community 95`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `useTheme()` connect `Community 460` to `Community 3`, `Community 20`, `Community 23`, `Community 2845`, `Community 161`, `Community 2615`, `Community 443`, `Community 191`, `Community 64`, `Community 207`, `Community 82`, `Community 84`, `Community 85`, `Community 346`, `Community 2783`, `Community 103`, `Community 104`, `Community 240`, `Community 115`, `Community 245`?**
