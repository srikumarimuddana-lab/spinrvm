...
|------|-------|--------|------|
| Assign a named privacy-officer / legal reviewer for this determination | Spinr leadership | ✅ Done — Spinr Team, Product Owner | 2026-09-08 |
| Review the question above and reach a determination | Privacy Officer / Legal | ✅ Done — option (a): needs a distinct disclosure | 2026-09-08 |
| Record the determination in the PIA (Section 8, R-G) and Section 9 sign-off | Privacy Officer / Legal | ✅ Done | 2026-09-08 |
| If disclosure is required: add language to `docs/legal/privacy-policy.md` before publication | Legal | ✅ Drafted — added to `docs/legal/privacy-policy.md` Section 6 (plus pre-publication note 6 documenting its factual basis). Tracked in `ACTION_ITEMS.md` B11 and `docs/legal/legal-text-publication-checklist.md`'s `privacy-policy.md` row. **Note:** the privacy policy is already live in production (published 2026-08-17, ahead of its own required counsel review) — this disclosure sentence is drafted only; it goes out at the document's next reviewed/re-published version, not as a standalone unreviewed edit to the already-live text. | 2026-09-11 |
| If an operational control change is recommended: file a new ACTION_ITEMS.md entry | Legal → Engineering | N/A — option (a) chosen, not (b) | — |
