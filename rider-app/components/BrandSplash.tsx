...
const STAGE_TOP = SCREEN_H * LOCKUP_CENTER_Y_FRACTION - WORDMARK_H / 2;
...
const TAGLINE_TOP = STAGE_TOP + WORDMARK_H + 22;
...
export default function BrandSplash({
  ...
  }, [reduceMotion, phase, markProgress, glowProgress, lettersOpacity, lettersY]);
