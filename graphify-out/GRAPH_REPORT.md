...
## Corpus Check
- 1811 files · ~2,602,382 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 32945 nodes · 59289 edges · 3537 communities (1562 shown, 1975 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6643 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c1ec24d`
...
## Communities (3537 total, 1975 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (89): admin_create_promotion(), admin_delete_promotion(), admin_get_promo_stats(), admin_get_promo_usage(), admin_get_promotions(), admin_update_promotion(), PromotionCreateRequest, PromotionUpdateRequest (+81 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (99): _apply_filters(), _build_or_clause(), _build_or_clause_term(), _CircuitBreaker, claim_driver_atomic(), claim_stripe_event(), count_documents(), create_complaint() (+91 more)
...
Cohesion: 0.02
Nodes (287): SettingsPage(), usePlacesAutocomplete(), PERIODS, RevenueCard(), RideStatsCards(), StatCard(), fetchDisputes(), fetchStats() (+279 more)
...
Cohesion: 0.04
Nodes (57): async(), createStyles(), DriverArrivedScreenContent(), handleCancelPress(), handleCopyOtp(), createStyles(), DriverArrivingScreenContent(), handleBack() (+49 more)
...
Cohesion: 0.02
Nodes (92): delete_one(), find_nearby_drivers(), find_one(), get_rows(), insert_one(), update_one(), test_find_nearby_drivers(), test_approve_driver_document() (+84 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (117): ForbiddenPage(), STATUS_COLORS, AllowanceDraft, AllowancesPage(), emptyDraft(), save(), AnalyticsPage(), DATE_RANGES (+109 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (55): admin_airport_zones_diagnostic(), admin_create_area_fee(), admin_create_service_area(), admin_delete_area_fee(), admin_delete_service_area(), admin_get_area_fees(), admin_get_area_tax(), admin_get_service_areas() (+47 more)
...
Cohesion: 0.04
Nodes (54): createStyles(), EmergencyContact, EmergencyContactsScreen(), RELATIONSHIPS, Card, createStyles(), fetchCards(), handleAddCard() (+46 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (28): get_service_area_polygon(), point_in_polygon(), Any, bool, float, str, Return polygon as list of {lat, lng} from a service area row.     Supports both, get_public_service_areas() (+20 more)
...
Cohesion: 0.06
Nodes (63): setAppCheckTokenProvider(), DriverRootLayoutInner(), GestureRootWrapper(), incentives, MaybeStripeProvider(), parsed, questHint, RootLayout() (+55 more)
...
Cohesion: 0.05
Nodes (44): str, Load a driver's ride only if it is in one of ``allowed_states``.      Raises 409, Load a driver's ride only if it is in one of ``allowed_states``.      Raises 409, _require_ride_in_state(), Load a rider's ride only if it is in one of allowed_states.      Raises 409 if t, Load a rider's ride only if it is in one of allowed_states.      Raises 409 if t, Load a rider's ride only if it is in one of allowed_states.      Raises 409 if t, _require_ride_in_state_rider() (+36 more)
...
Cohesion: 0.03
Nodes (98): DAYS, emptyWindow(), DAYS, emptyWindow(), AUDIENCE_OPTIONS, CloudMessage, CloudMessagingPage(), emptyStats (+90 more)
...
Cohesion: 0.13
Nodes (19): Request, add_card(), Add a saved card. Requires client-side tokenization.      Contract:       - Body, Add a saved card. Requires client-side tokenization.      Contract:       - Body, Invalid JSON body returns 400., test_add_card_invalid_json(), _mock_request(), Tests for the PCI-DSS perimeter on POST /payments/cards.  Pins the C-PAY-01 fix: (+11 more)
...
Cohesion: 0.06
Nodes (56): admin_create_fare_config(), admin_create_vehicle_type(), admin_delete_fare_config(), admin_delete_lost_item(), admin_delete_vehicle_type(), admin_get_fare_configs(), admin_get_vehicle_types(), admin_list_lost_and_found() (+48 more)

### Community 57 - "Community 57"
Cohesion: 0.03
Nodes (119): str, str, _app_with_mocked_auth(), _driver_row(), _make_ride(), _patch_settings(), _patch_stripe_confirm(), P0 ship-blocker tests — pins the five highest-priority end-to-end paths called o (+111 more)
...
Cohesion: 0.06
Nodes (55): CreateRideModal(), distanceKm(), FareRow(), PriceBreakdown, SelectedPlace, useDebounce(), RidesChart(), ZohoConfigCard() (+47 more)
...
Cohesion: 0.19
Nodes (18): apply(), Driver, DriverMap(), DriverMapProps, ServiceArea, Props, RideRouteMap(), LiveRideMap() (+10 more)
...
Cohesion: 0.07
Nodes (40): buildReceiptText(), createStyles(), fmt(), handleShareInvoice(), handleSubmit(), RideCompletedScreenContent(), showPaymentAlert(), toNum() (+32 more)
...
Cohesion: 0.06
Nodes (51): onRefresh(), AreaStat, AreaStatsTable(), ChartCard(), ChartData, DriverCharts(), tooltipStyle, DriverStatsCards() (+43 more)

### Community 78 - "Community 78"
Cohesion: 0.10
Nodes (58): _consume_retry_token(), bool, float, str, bool, int, str, Sku (+50 more)
...
Cohesion: 0.03
Nodes (80): asyncStoragePersister, queryClient, queryKeys, createStyles(), FormField(), FormFieldProps, handleSubmit(), showAlert() (+72 more)

### Community 83 - "Community 83"
Cohesion: 0.01
Nodes (427): Decimal, Request, str, str, Any, Validate all coordinates for a ride request.      Args:         pickup_lat: Pick, Validate all coordinates for a ride request.      Args:         pickup_lat: Pick, validate_ride_location() (+419 more)

### Community 84 - "Community 84"
Cohesion: 0.03
Nodes (74): Analytics, noop(), ConfirmPickupScreen(), createStyles(), haversineM(), CorporateAccount, createStyles(), PaymentConfirmScreenContent() (+66 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (51): getAuthHeader(), getStoredToken(), uploadFile(), fetchRequirements(), fetchVehicleTypes(), handleSubmit(), handleUpload(), nextStep() (+43 more)
...
Cohesion: 0.02
Nodes (221): admin_create_ride(), Admin manually creates a ride, optionally assigning a driver directly.      May, Admin manually creates a ride, optionally assigning a driver directly.      May, Admin manually creates a ride, optionally assigning a driver directly.      May, mark_stripe_event_processed(), FileTooLargeError, calculate_distance(), Decimal (+213 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (138): ActivityPage(), currentMonth(), formatCAD(), POLICY_RESULT_COLORS, STATUS_COLORS, formatDate(), AllowanceRequestsPage(), Filter (+130 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (30): StripeKeyContext, createStyles(), handleTopUp(), TOP_UP_AMOUNTS, TXN_COLORS, TXN_ICONS, WalletScreen(), recordNonFatal() (+22 more)
...
Cohesion: 0.03
Nodes (187): Any, BackgroundTasks, bool, float, RideRatingRequest, str, Any, Driver (+179 more)

### Community 96 - "Community 96"
Cohesion: 0.04
Nodes (43): float, int, str, get_current_user(), Return True if the access-token's token_version is stale.      Tokens minted bef, Resolve the current user using Firebase ID token (preferred) or fallback to lega, Resolve the current user using Firebase ID token (preferred) or fallback to lega, _token_version_mismatch() (+35 more)

### Community 97 - "Community 97"
Cohesion: 0.02
Nodes (166): DocumentRequirementCreateRequest, DocumentReviewRequest, NotificationRequest, admin_close_ticket(), admin_create_complaint(), admin_create_dispute(), admin_create_ticket(), admin_deactivate_flag() (+158 more)
...
Cohesion: 0.25
Nodes (16): DRIVER_COLOURS, driverColor(), fetchOSRMRoute(), MAP_CONTAINER_STYLE, MapHandles, MonitoringMap(), MonitoringMapProps, MonitoringServiceArea (+8 more)
...
Cohesion: 0.04
Nodes (64): defaultProps, { getAllByText }, { getByText }, initialMetrics, mockRide, mockRider, { queryByText }, renderWithSafeArea() (+56 more)
...
Cohesion: 0.04
Nodes (126): fare_split_pay_share(), increment_promo_uses(), PostgREST treats `*` as a wildcard in (i)like filters. Escape `*` and     `,` so, Convert one {col: predicate} pair into a PostgREST or_() leaf term., Flatten a list of {col: predicate} dicts into a PostgREST or_() string., Return the first row matching filters, or None., Bulk insert using Supabase's native batch insert (single round-trip)., Atomically increment a wallet balance. Returns the new balance. (+118 more)

### Community 107 - "Community 107"
Cohesion: 0.15
Nodes (28): Any, bool, str, Safety-incident reporting endpoint.  Drivers and riders submit safety/abuse repo, Record a safety incident submitted by a driver or rider., Record a safety incident submitted by a driver or rider., Record a safety incident submitted by a driver or rider., SafetyLocation (+20 more)
...
Cohesion: 0.07
Nodes (69): Any, bool, int, str, Any, bool, float, int (+61 more)

### Community 111 - "Community 111"
Cohesion: 0.02
Nodes (206): _active_subs_at(), admin_bulk_retry_payouts(), admin_cancel_ride(), admin_close_payout_period(), admin_complete_ride(), admin_export_drivers(), admin_export_filtered_rides(), admin_export_rides() (+198 more)
...
Cohesion: 0.06
Nodes (70): admin_credit_wallet(), admin_debit_wallet(), admin_get_wallet(), AdminCreditRequest, AdminDebitRequest, _q(), Admin wallet operations — credit a user's wallet, view balance + history.  Every, Credit a user's wallet. Writes an audited ledger entry. (+62 more)

### Community 115 - "Community 115"
Cohesion: 0.02
Nodes (121): AccessibilityScreen(), createStyles(), formatPhoneDisplay(), handlePhoneChange(), handleSendCode(), CATEGORY_ICONS, CLOSED_STATUSES, createStyles() (+113 more)
...
Cohesion: 0.06
Nodes (52): metrics(), str, str, float, int, str, int, str (+44 more)

### Community 118 - "Community 118"
Cohesion: 0.07
Nodes (43): admin_create_document_requirement(), admin_delete_document_requirement(), admin_get_document_requirements(), admin_get_driver_documents(), admin_get_pending_documents(), admin_review_driver_document(), admin_update_document_requirement(), admin_view_driver_document() (+35 more)
...
Cohesion: 0.03
Nodes (93): admin_create_requirement(), admin_delete_requirement(), admin_get_driver_documents(), admin_get_requirements(), admin_review_document(), admin_update_requirement(), delete_driver_document(), _extract_signed_url() (+85 more)
...
Cohesion: 0.06
Nodes (49): BillingPage(), downloadCSV(), formatCAD(), Metric(), monthOptions(), toCSV(), CancellationMixBar(), CeoMetricsHeader() (+41 more)

### Community 136 - "Community 136"
Cohesion: 0.06
Nodes (64): Activity, DriverActivity(), fmtDuration(), fmtTime(), Phase, PHASE_LABEL, Ride, shiftDate() (+56 more)
...
Cohesion: 0.10
Nodes (41): str, confirm_payment(), create_setup_intent(), get_cards(), get_or_create_stripe_customer(), get_payment_methods(), Confirm payment was successful, Create a SetupIntent to save a new payment method (+33 more)

### Community 139 - "Community 139"
Cohesion: 0.15
Nodes (26): float, str, _autotopup_wallet(), _expected_autotopup_key(), Replay-safety guarantees for payment-touching background loops.  CLAUDE.md, Back, When the conditional update returns None (another replica won     the race), the, The replica that wins the conditional update is the one that     notifies the dr, The claim filter must include payment_retry_count=<prior> so two     replicas ra (+18 more)

### Community 140 - "Community 140"
Cohesion: 0.11
Nodes (47): AllowanceRequestCreate, accept_member_invite(), get_corporate_account_by_id(), insert_corporate_member_invite(), list_active_memberships_for_user(), Decimal, str, Any (+39 more)
...
Cohesion: 0.07
Nodes (76): update_corporate_wallet_config(), bool, int, Request, Response, str, CompanyStatus, CompanyStatusTransition (+68 more)
...
Cohesion: 0.11
Nodes (22): Any, bool, int, str, Recursively prepare a payload for Supabase/PostgREST JSON encoding., _serialize_for_api(), claim_stripe_event(), fare_split_pay_share() (+14 more)

### Community 153 - "Community 153"
Cohesion: 0.06
Nodes (39): MagicMock, BaseSettings, Hash ADMIN_PASSWORD with bcrypt at startup (A-P3-1).          The plaintext env, Refuse to start in production with weak placeholder values, short         secret, Hash ADMIN_PASSWORD with bcrypt at startup (A-P3-1).          The plaintext en, Hash ADMIN_PASSWORD with bcrypt at startup (A-P3-1).          The plaintext env, Refuse to start in production with weak placeholder values, short         secre, Refuse to start in production with weak placeholder values, short         secret (+31 more)
...
Cohesion: 0.14
Nodes (21): ExtractedError, isStructured(), MaybeStructured, ShowAlertOptions, showErrorAlert(), getNestedValue(), i18n, LanguageState (+13 more)
...
Cohesion: 0.03
Nodes (67): _check_license_plate(), _check_vehicle_year(), _check_vin(), datetime, int, bool, datetime, Decimal (+59 more)
...
Cohesion: 0.17
Nodes (17): formatDate(), CopyableField(), Field(), formatCurrency(), handleRetry(), Payout, PayoutDetailPage(), RetryModal() (+9 more)
...
Cohesion: 0.05
Nodes (64): SettingsPage(), baseAction(), computeOptimisticUpdates(), DESTRUCTIVE_ACTIONS, DriverActionBar(), DriverActionBarProps, DriverStatus, getDriverStatus() (+56 more)
...
Cohesion: 0.03
Nodes (116): admin_add_driver_note(), admin_assign_driver_area(), admin_delete_driver_note(), admin_driver_action(), admin_driver_daily_activity(), admin_get_approval_queue(), admin_get_driver_activity(), admin_get_driver_daily_stats() (+108 more)
...
Cohesion: 0.05
Nodes (57): _fetch_rows_in_chunks(), get_analytics_overview(), get_cancellation_breakdown(), get_demand_forecast(), get_demand_forecast_summary(), get_driver_acceptance_rates(), get_driver_offer_stats(), get_driver_offer_trends() (+49 more)
...
Cohesion: 0.11
Nodes (34): bool, int, str, DispatchService — driver-matching logic separated from the HTTP layer.  Extracts, For destination-mode drivers, gate offers so we only forward rides     whose dro, _ride_brings_driver_closer_to_destination(), get_miss_streak(), increment_miss_streak() (+26 more)
...
Cohesion: 0.08
Nodes (21): Send a chat message for an active or recently completed ride.      Persists the, Send a chat message for an active or recently completed ride.      Persists the, Send a chat message for an active or recently completed ride.      Persists the, Send a chat message for an active or recently completed ride.      Persists the, send_ride_message(), SendMessageRequest, test_send_ride_message_not_found(), SendMessageRequest Pydantic model enforces 1–500 character bounds. (+13 more)
...
Cohesion: 0.13
Nodes (28): _client_factory(), _empty_settings(), _FakeClient, _FakeResp, _osrm_payload(), Tests for the OSRM /match road provider (distance + geometry) and selection.  OS, compute_road_distance_km stays back-compat: distance float or None., Minimal async-context httpx.AsyncClient stand-in. (+20 more)

### Community 342 - "Community 342"
Cohesion: 0.04
Nodes (35): _async_iter(), Coverage-boost tests — maps_eta, metrics, validators.  These tests target the ~1, Test _get_redis() directly to cover cache-hit and creation paths., Test RedisRateLimiter using its in-memory fallback path.      We do NOT need a r, is_rate_limited returns memory result when _get_redis returns 'memory'., _get_redis should set self._redis = 'memory' when connection fails., Tests for the get_client_identifier key function., Tests for the get_phone_based_key key function. (+27 more)
...
Cohesion: 0.03
Nodes (127): bool, float, int, RideRatingRequest, CreateRideRequest, DriverPublicView, Any, float (+119 more)
...
Cohesion: 0.02
Nodes (112): update_ride(), RideOTPRequest, client(), driver_1_headers(), driver_2_headers(), Unit tests for rides API and related functionality. Tests cover ride creation, u, Walk the complete ride state machine: accept → arrive → verify-otp → complete., Walk the complete ride state machine: accept → arrive → verify-otp → complete. (+104 more)
...
Cohesion: 0.08
Nodes (27): bool, Decimal, float, int, str, datetime, str, str (+19 more)
...
Cohesion: 0.07
Nodes (23): MagicMock, str, _mock_supabase_rpc_once_then_fail(), P3-4: Concurrent wallet debit tests.  The wallet_pay_for_ride and fare_split_pay, RPC exception containing 'wallet not found' → ValueError., Two concurrent debits on a wallet that can only cover one:         the mock mirr, Three concurrent debits, only one can win — mirrors a burst retry., The route must surface the ValueError as HTTP 400, not 500. (+15 more)
...
Cohesion: 0.03
Nodes (55): bool, str, FastAPI, str, DeprecatedRootPathMiddleware, health(), _loguru_sentry_sink(), _metrics_token() (+47 more)

### Community 423 - "Community 423"
Cohesion: 0.09
Nodes (21): Any, bool, float, int, str, Return ``(algorithm, min_rating, search_radius_km)`` for this ride.          Rea, Online + available + verified + *present* drivers for this ride.          is_ver, Return ``(algorithm, min_rating, search_radius_km,         max_offers, use_eta)` (+13 more)

### Community 425 - "Community 425"
Cohesion: 0.11
Nodes (15): Any, int, Request, str, _build_cache_key(), _extract_user_id(), idempotent_endpoint(), Idempotency-key support for non-idempotent write endpoints.  Pattern (RFC 9457 / (+7 more)
...
Cohesion: 0.04
Nodes (40): int, str, TestClient, str, object, str, _make_stripe_event(), Tests for routes/webhooks.py and routes/main.py.  webhooks.py is at 15.9% — the (+32 more)
...
Cohesion: 0.18
Nodes (13): float, str, str, _driver_row(), P1-9: Multi-stop E2E (R11)  The backend supports adding and removing stops on an, Adding a stop should trigger a fare recalculation., Pins remove_stop_mid_trip: stop removed by index, driver notified.      Code und, Pins add_stop_mid_trip: stop appended, driver notified via WS.      Code under t (+5 more)
...
Cohesion: 0.03
Nodes (82): ApiErrorBody, ApiErrorLogEntry, appCheckHeader(), clearApiErrorLog(), deadlineHeader(), ensureFreshToken(), _errorLog, extractError() (+74 more)
...
Cohesion: 0.05
Nodes (43): admin_cleanup_location_history(), admin_log_pii_reveal(), admin_rollup_driver_daily(), get_audit_logs(), log_audit(), PiiRevealRequest, Roll up driver activity for a single day into driver_daily_stats.      Captures:, Get audit log entries with optional filters and pagination. (+35 more)
...
Cohesion: 0.07
Nodes (37): handleLogoutEverywhere(), NAV_GROUPS, NavGroup, NavItem, Sidebar(), DashboardLayout(), cn(), RidePanel() (+29 more)
...
Cohesion: 0.14
Nodes (27): float, int, str, str, bench_http(), bench_ws(), check_regression(), main() (+19 more)
...
Cohesion: 0.14
Nodes (13): ConnectionStatus, FATAL_ERROR_MESSAGES, KNOWN_EVENT_TYPES, normalizeWsBaseUrl(), reconnectDelayWithJitter(), MockWebSocket, onEvent, originalEnv (+5 more)
...
Cohesion: 0.24
Nodes (12): str, Low-balance email notification tick., test_rate_limited_within_12h(), test_resends_after_rate_limit_elapsed(), test_sends_email_when_below_threshold_and_autotopup_off(), test_skips_when_company_missing_billing_email(), corporate_low_balance_loop(), _notify_one() (+4 more)
...
Cohesion: 0.21
Nodes (17): str, _alert_admins_payment_exhausted(), notify_driver_payout_failed(), payment_retry_loop(), _pod_id(), Payment retry — automatically retries failed ride payments with exponential back, Mark driver payouts that exceeded retry attempts as failed (8-5).      Replay-sa, Find and retry failed/stuck payments. (+9 more)
...
Cohesion: 0.12
Nodes (23): AppCache, CACHE_CONFIG, CACHE_KEYS, CacheEntry, CacheStorage, clog(), createStorage(), storage (+15 more)
...
Cohesion: 0.04
Nodes (81): build_monitoring_ride(), fetch_monitoring_drivers(), fetch_monitoring_rides(), flush_redis_prefix(), FlushPrefixRequest, get_infrastructure_stats(), get_monitoring_drivers(), get_monitoring_rides() (+73 more)
...
Cohesion: 0.06
Nodes (44): create_incentive(), delete_incentive(), get_incentive(), incentive_claim_stats(), IncentiveCreateRequest, IncentiveUpdateRequest, list_incentives(), toggle_incentive() (+36 more)
...
Cohesion: 0.19
Nodes (18): bool, create_payment_intent(), PaymentIntentRequest, Create a Stripe payment intent.      `amount` is validated by Pydantic (positive, Request body for POST /payments/create-intent., Create a Stripe payment intent.      `amount` is validated by Pydantic (positive, Request body for POST /payments/create-intent., Ride not found: the HTTPException(404) is re-raised as a 500 by the generic (+10 more)
...
Cohesion: 0.05
Nodes (59): AppSettings, Any, str, _defaults_dict(), get_app_settings(), Any, str, Single source of truth for app settings. Settings are stored as one row: id='app (+51 more)
...
Cohesion: 0.27
Nodes (16): Any, datetime, str, close_linked_records(), When Zoho tickets close, close the linked Spinr records (reverse sync).      Cal, Raised when Zoho Desk is misconfigured or returns an error.      ``status`` is t, ZohoDeskError, _map_ticket() (+8 more)
...
Cohesion: 0.06
Nodes (42): handleCodeChange(), handleResend(), handleVerify(), triggerShake(), createStyles(), DriverData, DriverTopBarProps, AddressesScreen() (+34 more)
...
Cohesion: 0.22
Nodes (14): admin_create_faq(), admin_delete_faq(), admin_get_faqs(), admin_get_notifications(), admin_send_notification(), admin_update_faq(), FaqCreateRequest, FaqUpdateRequest (+6 more)
...
Cohesion: 0.20
Nodes (16): notify_safety_team(), Fan out a safety_incidents row to the configured alert channels.      Three side, Fan out a safety_incidents row to the configured alert channels.      Three side, datetime, str, redis_set(), _escalate(), _escalated_key() (+8 more)
...
Cohesion: 0.29
Nodes (5): code:python (from fastapi.middleware.cors import CORSMiddleware), File: `backend/core/middleware.py`, P3: HttpOnly Token Storage — Detailed Implementation Guide, Security Review Checklist, Step 5: Middleware — CORS + Cookie Support
...
Cohesion: 0.26
Nodes (13): float, int, str, batch_get_etas(), get_ride_eta_seconds(), _haversine_eta_seconds(), _haversine_km(), Road-network ETA helper (OSRM-first, Google Distance Matrix fallback).  Computes (+5 more)
...
Cohesion: 0.39
Nodes (6): str, Server-side device integrity verification.  Validates device attestation signals, Evaluate device trust level. Returns {"trusted": bool, "risk_tier": str, "reason, Store attestation result for admin visibility and pattern detection., _record_attestation(), verify_device()
...
Cohesion: 0.20
Nodes (14): add_allowed_domain(), get_member_by_invite_token(), list_company_members(), list_pending_allowance_requests_for_member(), Thin happy-path tests for the Plan-3 db_supabase helpers.  The helpers are pass-, test_accept_member_invite_flips_status(), test_add_allowed_domain_inserts_lowercase(), test_get_member_by_invite_token_returns_row() (+6 more)
...
Cohesion: 0.04
Nodes (67): str, init_firebase(), Initialize Firebase Admin SDK, Initialize Firebase Admin SDK, create_jwt_token(), create_refresh_token(), generate_otp(), hash_token() (+59 more)
...
Cohesion: 0.19
Nodes (11): bool, int, str, _is_otp_key(), Lazy Redis connection., Check if a key is rate limited.          Args:             key: Unique identifie, Lazy Redis connection., Check if a key is rate limited.          Args:             key: Unique identifie (+3 more)
...
Cohesion: 0.23
Nodes (8): MAP_STYLE_FALLBACK, Centered(), DEFAULT_CENTER, EN_ROUTE_TO_PICKUP, G, RideInfo, STATUS_LABEL, TrackRide()
...
Cohesion: 0.29
Nodes (8): GeofenceMap(), GeofenceMapProps, lineStringGeoJSON(), pointsToGeoJSON(), pointsToVerticesGeoJSON(), PolygonPoint, toolbarButtonStyle, polygonPointsToGeoJSON()
...
Cohesion: 0.26
Nodes (10): list_allowances_due_for_reset(), reset_allowance_period(), int, date, Monthly allowance reset tick tests (Task 9)., test_reset_runs_for_stale_allowances(), test_reset_skips_rollover_flag(), _add_one_month() (+2 more)
...
Cohesion: 0.12
Nodes (18): styles, RideStatusScreen(), Driver, Location, NearbyDriver, Ride, RideEstimate, RideState (+10 more)
...
Cohesion: 0.05
Nodes (93): AuthResponse, bool, int, Response, str, bool, datetime, int (+85 more)
...
Cohesion: 0.39
Nodes (7): DROPOFF_GRADIENT_EXPR, HeatMap(), HeatMapPoint, HeatMapProps, HeatMapSettings, PICKUP_GRADIENT_EXPR, pointsToFeatureCollection()
...
Cohesion: 0.25
Nodes (8): delete_card(), Detach card from Stripe and clear default if needed., Detach card from Stripe and clear default if needed., Stripe detach failure is logged but does not raise — DB cleanup still runs., test_delete_card_detaches_and_clears_default(), test_delete_card_no_stripe_key_skips_detach(), test_delete_card_non_default_skips_db_clear(), test_delete_card_stripe_error_logged_not_raised()

### Community 3508 - "Community 3508"
Cohesion: 0.25
Nodes (8): Set card as default. Updates both our DB and Stripe customer., Set card as default. Updates both our DB and Stripe customer., set_default_card(), get_app_settings(), Stripe failure on set_default_card is logged but does not raise — DB update stil, test_set_default_card_no_stripe_key_still_updates_db(), test_set_default_card_stripe_error_logged_not_raised(), test_set_default_card_updates_db_and_stripe()
...
Cohesion: 0.24
Nodes (10): loginAdminSession(), mfaChallenge(), handleLogin(), handleMfaSubmit(), LoginForm(), LoginPage(), sanitizeNextPath(), _storeSessionAndRedirect() (+2 more)
...
- **1975 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `SpinrException` connect `Community 95` to `Community 6`, `Community 7`, `Community 138`, `Community 146`, `Community 148`, `Community 279`, `Community 153`, `Community 28`, `Community 157`, `Community 34`, `Community 49`, `Community 53`, `Community 2615`, `Community 57`, `Community 3513`, `Community 2366`, `Community 3391`, `Community 83`, `Community 90`, `Community 2783`, `Community 98`, `Community 106`, `Community 366`, `Community 114`, `Community 376`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Auth & Users Domain` connect `Community 520` to `Community 131`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Rides, Dispatch & Drivers Domain` connect `Community 155` to `Community 520`, `Community 2459`, `Community 3510`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
...
- **What connects `_comment`, `command`, `args` to the rest of the system?**
  _15843 weakly-connected nodes found - possible documentation gaps or missing edges._