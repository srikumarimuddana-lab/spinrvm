...
// Never fall back to localhost in production — a misconfigured deployment must
// fail loudly rather than silently proxying to nowhere ([18-4]).
const BACKEND_URL =
  process.env.BACKEND_URL ||
  process.env.NEXT_PUBLIC_API_URL ||
  (process.env.NODE_ENV !== "production" ? "http://127.0.0.1:8000" : undefined);
