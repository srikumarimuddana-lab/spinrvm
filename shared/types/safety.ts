...
export function deriveContactOutcome(result: SOSTriggerResult | void | null): SOSContactOutcome {
  // A caller that returns nothing (older/void-typed onTrigger, or a driver
  // path that doesn't surface contacts) is treated as "no contacts" rather
  // than silently claiming success -- fail toward the weaker claim.
