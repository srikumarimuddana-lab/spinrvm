...
close snapshot RPC output. It is a forward-only function replacement with no
table or row changes. Dry-run scenarios: a completed clawback alone contributes
