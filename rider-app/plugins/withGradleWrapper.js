...
// @logrocket/react-native, etc.). Gradle 8.13 is the minimum required by AGP 8.10.x (the
// version in the EAS build environment at buildTools 36.0.0). Still in the 8.x family so
// deprecated `compile` configs used by old native modules continue to work.
